...
class Observable(pydantic.BaseModel):
    ...
    reputation: typing.Optional[Reputation] = pydantic.Field(
        description="Contains the original and normalized reputation scores."
    )
    type: typing.Optional[str] = pydantic.Field(description="The observable value type name.")
    type_id: ObservableTypeId = pydantic.Field(description="The observable value type identifier.")
