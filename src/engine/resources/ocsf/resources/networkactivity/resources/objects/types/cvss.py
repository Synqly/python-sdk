...
class Cvss(pydantic.BaseModel):
    ...
    base_score: float = pydantic.Field(description="The CVSS base score. For example: <code>9.1</code>.")
    depth: typing.Optional[CvssDepth] = pydantic.Field(
    ...
    overall_score: typing.Optional[float] = pydantic.Field(
    ...
    vector_string: typing.Optional[str] = pydantic.Field(
    ...
    version: str = pydantic.Field(description="The CVSS version. For example: <code>3.1</code>.")
