...
class FileActivity(pydantic.BaseModel):
    ...
    access_mask: typing.Optional[int] = pydantic.Field(description="The access mask in a platform-native format.")
    activity_id: ActivityId = pydantic.Field(description="The activity ID of the event.")
    activity_name: typing.Optional[str] = pydantic.Field(
        description="The event activity name, as defined by the activity_id."
    )
    actor: Actor = pydantic.Field(description="The actor that performed the activity on the <code>file</code> object")
    ...
    connection_uid: typing.Optional[str] = pydantic.Field(description="The network connection identifier.")
    count: typing.Optional[int] = pydantic.Field(
        description="The number of times that events in the same logical group occurred during the event <strong>Start Time</strong> to <strong>End Time</strong> period."
    )
    create_mask: typing.Optional[str] = pydantic.Field(
    ...
    file: File = pydantic.Field(description="The file that is the target of the activity.")
    file_diff: typing.Optional[str] = pydantic.Field(
    ...
    file_result: typing.Optional[File] = pydantic.Field(
