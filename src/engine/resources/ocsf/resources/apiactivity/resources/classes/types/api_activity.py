...
class ApiActivity(pydantic.BaseModel):
    ...
    dst_endpoint: typing.Optional[NetworkEndpoint] = pydantic.Field(description="The network destination endpoint.")
    ...
    src_endpoint: NetworkEndpoint = pydantic.Field(description="Details about the source of the activity.")
