...
class InventoryInfo(pydantic.BaseModel):
    """
    ...
    category_name: typing.Optional[str] = pydantic.Field(
        description="The event category name, as defined by category_uid value: <code>Discovery</code>."
    )
    ...
    device: Device = pydantic.Field(description="The device that is being discovered by an inventory process.")
