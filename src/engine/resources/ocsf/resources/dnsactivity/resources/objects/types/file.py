...
class File(pydantic.BaseModel):
    ...
    accessed_time: typing.Optional[Timestamp] = pydantic.Field(description="The time when the file was last accessed.")
    accessed_time_dt: typing.Optional[dt.datetime] = pydantic.Field(
        description="The time when the file was last accessed."
    )
    accessor: typing.Optional[User] = pydantic.Field(description="The name of the user who last accessed the object.")
    attributes: typing.Optional[int] = pydantic.Field(
    ...
    confidentiality: typing.Optional[str] = pydantic.Field(
    ...
    created_time: typing.Optional[Timestamp] = pydantic.Field(description="The time when the file was created.")
    created_time_dt: typing.Optional[dt.datetime] = pydantic.Field(description="The time when the file was created.")
    creator: typing.Optional[User] = pydantic.Field(description="The user that created the file.")
    ...
    hashes: typing.Optional[typing.List[Fingerprint]] = pydantic.Field(description="An array of hash attributes.")
    is_system: typing.Optional[bool] = pydantic.Field(
    ...
    modified_time: typing.Optional[Timestamp] = pydantic.Field(description="The time when the file was last modified.")
    modified_time_dt: typing.Optional[dt.datetime] = pydantic.Field(
        description="The time when the file was last modified."
    )
    modifier: typing.Optional[User] = pydantic.Field(description="The user that last modified the file.")
    name: FileName = pydantic.Field(description="The name of the file. For example: <code>svchost.exe</code>")
    owner: typing.Optional[User] = pydantic.Field(description="The user that owns the file/object.")
    ...
    product: typing.Optional[Product] = pydantic.Field(description="The product that created or installed the file.")
    security_descriptor: typing.Optional[str] = pydantic.Field(description="The object security descriptor.")
    signature: typing.Optional[DigitalSignature] = pydantic.Field(description="The digital signature of the file.")
    size: typing.Optional[int] = pydantic.Field(description="The size of data, in bytes.")
    type: typing.Optional[str] = pydantic.Field(description="The file type.")
    type_id: FileTypeId = pydantic.Field(description="The file type ID.")
    ...
    xattributes: typing.Optional[Object] = pydantic.Field(
