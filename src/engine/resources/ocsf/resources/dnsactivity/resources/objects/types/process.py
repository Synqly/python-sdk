...
class Process(pydantic.BaseModel):
    ...
    auid: typing.Optional[int] = pydantic.Field(description="The audit user assigned at login by the audit subsystem.")
    cmd_line: typing.Optional[str] = pydantic.Field(
    ...
    egid: typing.Optional[int] = pydantic.Field(description="The effective group under which this process is running.")
    euid: typing.Optional[int] = pydantic.Field(description="The effective user under which this process is running.")
    file: typing.Optional[File] = pydantic.Field(description="The process file object.")
    group: typing.Optional[Group] = pydantic.Field(description="The group under which this process is running.")
    integrity: typing.Optional[str] = pydantic.Field(
    ...
    integrity_id: typing.Optional[ProcessIntegrityId] = pydantic.Field(
        description="The normalized identifier of the process integrity level (Windows only)."
    )
    lineage: typing.Optional[typing.List[str]] = pydantic.Field(
    ...
    loaded_modules: typing.Optional[typing.List[str]] = pydantic.Field(description="The list of loaded module names.")
    name: typing.Optional[ProcessName] = pydantic.Field(
    ...
    parent_process: typing.Optional[Process] = pydantic.Field(
    ...
    sandbox: typing.Optional[str] = pydantic.Field(
    ...
    terminated_time: typing.Optional[Timestamp] = pydantic.Field(
        description="The time when the process was terminated."
    )
    terminated_time_dt: typing.Optional[dt.datetime] = pydantic.Field(
        description="The time when the process was terminated."
    )
    tid: typing.Optional[int] = pydantic.Field(
    ...
    user: typing.Optional[User] = pydantic.Field(description="The user under which this process is running.")
