...
class ProcessActivity(pydantic.BaseModel):
    ...
    actual_permissions: typing.Optional[int] = pydantic.Field(
    ...
    exit_code: typing.Optional[int] = pydantic.Field(
    ...
    injection_type: typing.Optional[str] = pydantic.Field(
    ...
    injection_type_id: typing.Optional[InjectionTypeId] = pydantic.Field(
    ...
    module: typing.Optional[Module] = pydantic.Field(description="The module that was injected by the actor process.")
    ...
    requested_permissions: typing.Optional[int] = pydantic.Field(
