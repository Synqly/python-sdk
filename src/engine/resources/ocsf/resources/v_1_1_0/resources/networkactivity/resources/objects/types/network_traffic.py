...
class NetworkTraffic(pydantic.BaseModel):
    ...
    bytes: typing.Optional[int] = pydantic.Field(description="The total number of bytes (in and out).")
    bytes_in: typing.Optional[int] = pydantic.Field(
        description="The number of bytes sent from the destination to the source."
    )
    bytes_out: typing.Optional[int] = pydantic.Field(
        description="The number of bytes sent from the source to the destination."
    )
    chunks: typing.Optional[int] = pydantic.Field(description="The total number of chunks (in and out).")
    chunks_in: typing.Optional[int] = pydantic.Field(
        description="The number of chunks sent from the destination to the source."
    )
    chunks_out: typing.Optional[int] = pydantic.Field(
        description="The number of chunks sent from the source to the destination."
    )
    packets: typing.Optional[int] = pydantic.Field(description="The total number of packets (in and out).")
    packets_in: typing.Optional[int] = pydantic.Field(
        description="The number of packets sent from the destination to the source."
    )
    packets_out: typing.Optional[int] = pydantic.Field(
