...
class FirewallRule(pydantic.BaseModel):
    ...
    category: typing.Optional[str] = pydantic.Field(description="The rule category.")
    ...
    desc: typing.Optional[str] = pydantic.Field(description="The description of the rule that generated the event.")
    ...
    match_details: typing.Optional[typing.List[str]] = pydantic.Field(
        description='The data in a request that rule matched. For example: \'["10","and","1"]\'.'
    )
    match_location: typing.Optional[str] = pydantic.Field(
    ...
    name: typing.Optional[str] = pydantic.Field(description="The name of the rule that generated the event.")
    rate_limit: typing.Optional[int] = pydantic.Field(description="The rate limit for a rate-based rule.")
    sensitivity: typing.Optional[str] = pydantic.Field(
        description="The sensitivity of the firewall rule in the matched event. For example: HIGH."
    )
    type: typing.Optional[str] = pydantic.Field(description="The rule type.")
    uid: typing.Optional[str] = pydantic.Field(
        description="The unique identifier of the rule that generated the event."
    )
    version: typing.Optional[str] = pydantic.Field(description="The rule version. For example: <code>1.1</code>.")
