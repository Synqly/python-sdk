...
class Cve(pydantic.BaseModel):
    ...
    cvss: typing.Optional[typing.List[Cvss]] = pydantic.Field(
    ...
    cwe: typing.Optional[Cwe] = pydantic.Field(
    ...
    desc: typing.Optional[str] = pydantic.Field(description="A brief description of the CVE Record.")
    epss: typing.Optional[Epss] = pydantic.Field(
    ...
    title: typing.Optional[str] = pydantic.Field(description="A title or a brief phrase summarizing the CVE record.")
