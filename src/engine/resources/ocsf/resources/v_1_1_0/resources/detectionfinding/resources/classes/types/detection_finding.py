...
class DetectionFinding(pydantic.BaseModel):
    ...
    activity_id: ActivityId = pydantic.Field(description="The normalized identifier of the finding activity.")
    ...
    comment: typing.Optional[str] = pydantic.Field(description="A user provided comment about the finding.")
    ...
    evidences: typing.Optional[typing.List[Evidences]] = pydantic.Field(
    ...
    status_id: typing.Optional[StatusId] = pydantic.Field(
