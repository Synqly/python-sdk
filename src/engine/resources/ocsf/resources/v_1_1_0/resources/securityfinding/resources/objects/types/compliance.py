...
class Compliance(pydantic.BaseModel):
    ...
    control: typing.Optional[str] = pydantic.Field(
    ...
    status_code: typing.Optional[str] = pydantic.Field(description="The resultant status code of the compliance check.")
    status_detail: typing.Optional[str] = pydantic.Field(
        description="The contextual description of the status, status_code values."
    )
    status_id: typing.Optional[ComplianceStatusId] = pydantic.Field(
