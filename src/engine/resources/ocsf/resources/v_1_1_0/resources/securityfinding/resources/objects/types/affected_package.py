...
class AffectedPackage(pydantic.BaseModel):
    ...
    epoch: typing.Optional[int] = pydantic.Field(
        description="The software package epoch. Epoch is a way to define weighted dependencies based on version numbers."
    )
    fixed_in_version: typing.Optional[str] = pydantic.Field(
        description="The software package version in which a reported vulnerability was patched/fixed."
    )
    license: typing.Optional[str] = pydantic.Field(description="The software license applied to this package.")
    name: str = pydantic.Field(description="The software package name.")
    package_manager: typing.Optional[str] = pydantic.Field(
        description="The software packager manager utilized to manage a package on a system, e.g. npm, yum, dpkg etc."
    )
    path: typing.Optional[str] = pydantic.Field(description="The installation path of the affected package.")
    purl: typing.Optional[str] = pydantic.Field(
    ...
    version: str = pydantic.Field(description="The software package version.")
