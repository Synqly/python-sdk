...
class User(pydantic.BaseModel):
    ...
    email_addr: typing.Optional[EmailAddress] = pydantic.Field(description="The user's primary email address.")
    ...
    ldap_person: typing.Optional[LdapPerson] = pydantic.Field(
    ...
    type_id: typing.Optional[UserTypeId] = pydantic.Field(description="The account type identifier.")
