...
class IncidentFinding(pydantic.BaseModel):
    ...
    activity_id: ActivityId = pydantic.Field(description="The normalized identifier of the Incident activity.")
    ...
    assignee: typing.Optional[User] = pydantic.Field(description="The details of the user assigned to an Incident.")
    assignee_group: typing.Optional[Group] = pydantic.Field(
    ...
    desc: typing.Optional[str] = pydantic.Field(description="The short description of the Incident.")
    ...
    is_suspected_breach: typing.Optional[bool] = pydantic.Field(
    ...
    priority_id: typing.Optional[PriorityId] = pydantic.Field(
    ...
    src_url: typing.Optional[UrlString] = pydantic.Field(description="A Url link used to access the original incident.")
    ...
    status_id: StatusId = pydantic.Field(description="The normalized status identifier of the Incident.")
    ...
    verdict: typing.Optional[str] = pydantic.Field(description="The verdict assigned to an Incident finding.")
    verdict_id: typing.Optional[VerdictId] = pydantic.Field(description="The normalized verdict of an Incident.")
