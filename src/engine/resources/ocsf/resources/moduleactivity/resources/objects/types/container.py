...
class Container(pydantic.BaseModel):
    ...
    hash: typing.Optional[Fingerprint] = pydantic.Field(
    ...
    name: typing.Optional[str] = pydantic.Field(description="The container name.")
    network_driver: typing.Optional[str] = pydantic.Field(
    ...
    size: typing.Optional[int] = pydantic.Field(description="The size of the container image.")
