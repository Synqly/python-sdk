...
class SlackCredential_Token(TokenCredential):
...
class SlackCredential_TokenId(pydantic.BaseModel):
...
SlackCredential = typing.Union[SlackCredential_Token, SlackCredential_TokenId]
