...
class VulnerabilitiesTenableCloud(pydantic.BaseModel):
    ...
    url: typing.Optional[str] = pydantic.Field(
        description='URL for the Tenable Cloud API. This should be the base URL for the API, without any path components and must be HTTPS. If not provided, defaults to "https://cloud.tenable.com".'
    )
