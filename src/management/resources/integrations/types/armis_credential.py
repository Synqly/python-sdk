...
class ArmisCredential_Token(TokenCredential):
...
class ArmisCredential_TokenId(pydantic.BaseModel):
...
ArmisCredential = typing.Union[ArmisCredential_Token, ArmisCredential_TokenId]
