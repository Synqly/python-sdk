...
class TicketingServiceNow(pydantic.BaseModel):
    ...
    url: str = pydantic.Field(
        description='URL for the ServiceNow API. This should be the base URL for the API, without any path components and must be HTTPS. For example, "https://tenant.service-now.com".'
    )
