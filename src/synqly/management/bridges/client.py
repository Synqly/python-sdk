...
class BridgesClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListBridgesResponse, construct_type(type_=ListBridgesResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetBridgeResponse, construct_type(type_=GetBridgeResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_status(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetBridgeStatusResponse, construct_type(type_=GetBridgeStatusResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/bridges/{jsonable_encoder(account_id)}",
            method="POST",
            json={"name": name, "fullname": fullname, "description": description, "labels": labels},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateBridgeResponse, construct_type(type_=CreateBridgeResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateBridgeResponse, construct_type(type_=UpdateBridgeResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchBridgeResponse, construct_type(type_=PatchBridgeResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
