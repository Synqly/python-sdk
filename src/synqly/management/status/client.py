...
class StatusClient:
    ...
    def list(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/status",
            method="GET",
            params={"limit": limit, "start_after": start_after, "order": order, "filter": filter, "expand": expand},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListStatusResponse, construct_type(type_=ListStatusResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetStatusResponse, construct_type(type_=GetStatusResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def list_events(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListStatusEventsResponse, construct_type(type_=ListStatusEventsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_timeseries(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetStatusTimeseries:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/status/timeseries", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetStatusTimeseries, construct_type(type_=GetStatusTimeseries, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_integration_timeseries(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetIntegrationTimeseries, construct_type(type_=GetIntegrationTimeseries, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
