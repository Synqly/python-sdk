...
class TokensClient:
    ...
    def create_token(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/tokens",
            method="POST",
            json={"name": name, "resources": resources, "permission_set": permission_set, "token_ttl": token_ttl},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateTokenResponse, construct_type(type_=CreateTokenResponse, object_=_response.json()))  # type: ignore
    ...
    def create_integration_token(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"name": name, "token_ttl": token_ttl},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateIntegrationTokenResponse, construct_type(type_=CreateIntegrationTokenResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create_synqly_integrations_token(
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"token_ttl": token_ttl},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateSynqlyIntegrationsTokenResponse, construct_type(type_=CreateSynqlyIntegrationsTokenResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def delete(self, refresh_token_id: TokenId, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/tokens/{jsonable_encoder(refresh_token_id)}", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
    ...
    def list(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListTokensResponse, construct_type(type_=ListTokensResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/tokens/{jsonable_encoder(refresh_token_id)}/info", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetTokenResponse, construct_type(type_=GetTokenResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def reset(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ResetTokenResponse, construct_type(type_=ResetTokenResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def refresh(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/tokens/{jsonable_encoder(refresh_token_id)}/refresh", method="PUT", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(RefreshTokenResponse, construct_type(type_=RefreshTokenResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
