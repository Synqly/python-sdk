...
class OperationId(enum.StrEnum):
    ...
    ENDPOINTMANAGEMENT_QUERY_DEVICE_APPLICATIONS = "endpointmanagement_query_device_applications"
    ...
    VULNERABILITIES_QUERY_SCAN_FINDINGS = "vulnerabilities_query_scan_findings"
    ...
    _UNKNOWN = "__OPERATIONID_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "OperationId":
    ...
    def visit(
        ...
        vulnerabilities_query_scan_findings: typing.Callable[[], T_Result],
        ...
        if self is OperationId.NETWORKSECURITY_QUERY_TRAFFIC_LOG_CONFIGURATIONS:
            return networksecurity_query_traffic_log_configurations()
        ...
        if self is OperationId.VULNERABILITIES_QUERY_SCAN_FINDINGS:
            return vulnerabilities_query_scan_findings()
