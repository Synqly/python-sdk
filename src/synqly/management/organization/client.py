...
class OrganizationClient:
    ...
    def get(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetOrganizationResponse:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/organization", method="GET", request_options=request_options
        )
        try:
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateOrganizationResponse, construct_type(type_=UpdateOrganizationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/organization", method="PATCH", json=request, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchOrganizationResponse, construct_type(type_=PatchOrganizationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
