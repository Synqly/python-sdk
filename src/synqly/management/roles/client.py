...
class RolesClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListRolesResponse, construct_type(type_=ListRolesResponse, object_=_response.json()))  # type: ignore
    ...
    def get(self, role_id: RoleId, *, request_options: typing.Optional[RequestOptions] = None) -> GetRoleResponse:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/roles/{jsonable_encoder(role_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetRoleResponse, construct_type(type_=GetRoleResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateRoleResponse, construct_type(type_=CreateRoleResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/roles/{jsonable_encoder(role_id)}",
            method="PUT",
            json={
                "id": id,
                "fullname": fullname,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateRoleResponse, construct_type(type_=UpdateRoleResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchRoleResponse, construct_type(type_=PatchRoleResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def delete(self, role_id: RoleId, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/roles/{jsonable_encoder(role_id)}", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
