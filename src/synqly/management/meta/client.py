...
class MetaClient:
    ...
    def management_openapi_spec(
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/meta/openapi/management", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetOpenApiSpecResponse, construct_type(type_=GetOpenApiSpecResponse, object_=_response.json()))  # type: ignore
    ...
    def engine_openapi_spec(self, *, request_options: typing.Optional[RequestOptions] = None) -> GetOpenApiSpecResponse:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/meta/openapi/engine", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetOpenApiSpecResponse, construct_type(type_=GetOpenApiSpecResponse, object_=_response.json()))  # type: ignore
