...
class CredentialsClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListCredentialsResponse, construct_type(type_=ListCredentialsResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetCredentialResponse, construct_type(type_=GetCredentialResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def lookup(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/credentials/lookup/{jsonable_encoder(credential_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(LookupCredentialResponse, construct_type(type_=LookupCredentialResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/credentials/{jsonable_encoder(owner_id)}",
            method="POST",
            json={"name": name, "fullname": fullname, "config": config, "owner_type": owner_type, "expires": expires},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateCredentialResponse, construct_type(type_=CreateCredentialResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateCredentialResponse, construct_type(type_=UpdateCredentialResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchCredentialResponse, construct_type(type_=PatchCredentialResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
