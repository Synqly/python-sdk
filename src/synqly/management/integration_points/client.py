...
class IntegrationPointsClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListIntegrationPointsResponse, construct_type(type_=ListIntegrationPointsResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetIntegrationPointResponse, construct_type(type_=GetIntegrationPointResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateIntegrationPointResponse, construct_type(type_=CreateIntegrationPointResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateIntegrationPointResponse, construct_type(type_=UpdateIntegrationPointResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchIntegrationPointResponse, construct_type(type_=PatchIntegrationPointResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
