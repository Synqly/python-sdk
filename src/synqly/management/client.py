...
from .resources.capabilities_beta.client import AsyncCapabilitiesBetaClient, CapabilitiesBetaClient
...
class SynqlyManagement:
    ...
    def __init__(
        ...
        *,
        ...
        self.capabilities_beta = CapabilitiesBetaClient(client_wrapper=self._client_wrapper)
...
class AsyncSynqlyManagement:
    ...
    def __init__(
        ...
        *,
        ...
        self.capabilities_beta = AsyncCapabilitiesBetaClient(client_wrapper=self._client_wrapper)
