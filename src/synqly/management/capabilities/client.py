...
class CapabilitiesClient:
    ...
    def list_connectors(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/capabilities/connectors", method="GET", params={"expand": expand}, request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListConnectorsCapabilitiesResponse, construct_type(type_=ListConnectorsCapabilitiesResponse, object_=_response.json()))  # type: ignore
    ...
    def list_providers(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/capabilities/providers", method="GET", params={"expand": expand}, request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListProvidersCapabilitiesResponse, construct_type(type_=ListProvidersCapabilitiesResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_provider(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ProviderCapabilitiesResponse, construct_type(type_=ProviderCapabilitiesResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
