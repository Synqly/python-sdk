...
class ProviderOperations(UncheckedBaseModel):
    ...
    request_method: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    HTTP method used for the operation.
    """

    request_path: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    URI template path for the operation, including path parameters.
    """

    supported: bool = pydantic_v1.Field()
    """
    Whether the operation is supported by the provider.
    """

    required_fields: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    supported_response_fields: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    filters: typing.Optional[typing.List[ProviderFilter]] = pydantic_v1.Field(default=None)
    """
    Filters that can be applied to this operation.
    """

    request_body: typing.Optional[RequestBody] = pydantic_v1.Field(default=None)
    """
