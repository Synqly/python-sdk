...
class EdrSentinelOne(UncheckedBaseModel):
    ...
    edr_events_credential: typing.Optional[SentinelOneEdrEventsCredential] = pydantic_v1.Field(default=None)
    """
    Credential used for the SentinelOne Singularity Data Lake API. This credential is required when querying EDR events.
    """

    edr_events_url: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
