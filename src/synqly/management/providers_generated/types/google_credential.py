...
class GoogleCredential_OAuthClient(UncheckedBaseModel):
...
class GoogleCredential_OAuthClientId(UncheckedBaseModel):
...
GoogleCredential = typing_extensions.Annotated[
    typing.Union[GoogleCredential_OAuthClient, GoogleCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
