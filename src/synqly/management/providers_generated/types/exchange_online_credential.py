...
class ExchangeOnlineCredential_OAuthClient(UncheckedBaseModel):
...
class ExchangeOnlineCredential_OAuthClientId(UncheckedBaseModel):
...
ExchangeOnlineCredential = typing_extensions.Annotated[
    typing.Union[ExchangeOnlineCredential_OAuthClient, ExchangeOnlineCredential_OAuthClientId],
