...
class AzureNetworkSecurityCredential_OAuthClient(UncheckedBaseModel):
...
class AzureNetworkSecurityCredential_OAuthClientId(UncheckedBaseModel):
...
AzureNetworkSecurityCredential = typing_extensions.Annotated[
    typing.Union[AzureNetworkSecurityCredential_OAuthClient, AzureNetworkSecurityCredential_OAuthClientId],
