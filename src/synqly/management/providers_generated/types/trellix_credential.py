...
class TrellixCredential_OAuthClient(UncheckedBaseModel):
...
class TrellixCredential_OAuthClientId(UncheckedBaseModel):
...
TrellixCredential = typing_extensions.Annotated[
    typing.Union[TrellixCredential_OAuthClient, TrellixCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
