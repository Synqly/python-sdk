...
class IntuneCredential_OAuthClient(UncheckedBaseModel):
...
class IntuneCredential_OAuthClientId(UncheckedBaseModel):
...
IntuneCredential = typing_extensions.Annotated[
    typing.Union[IntuneCredential_OAuthClient, IntuneCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
