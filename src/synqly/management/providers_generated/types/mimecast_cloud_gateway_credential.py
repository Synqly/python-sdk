...
class MimecastCloudGatewayCredential_OAuthClient(UncheckedBaseModel):
...
class MimecastCloudGatewayCredential_OAuthClientId(UncheckedBaseModel):
...
MimecastCloudGatewayCredential = typing_extensions.Annotated[
    typing.Union[MimecastCloudGatewayCredential_OAuthClient, MimecastCloudGatewayCredential_OAuthClientId],
