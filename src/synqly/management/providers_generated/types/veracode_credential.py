...
class VeracodeCredential_OAuthClient(UncheckedBaseModel):
...
class VeracodeCredential_OAuthClientId(UncheckedBaseModel):
...
VeracodeCredential = typing_extensions.Annotated[
    typing.Union[VeracodeCredential_OAuthClient, VeracodeCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
