...
class HclAppScanOnCloudCredential_OAuthClient(UncheckedBaseModel):
...
class HclAppScanOnCloudCredential_OAuthClientId(UncheckedBaseModel):
...
HclAppScanOnCloudCredential = typing_extensions.Annotated[
    typing.Union[HclAppScanOnCloudCredential_OAuthClient, HclAppScanOnCloudCredential_OAuthClientId],
