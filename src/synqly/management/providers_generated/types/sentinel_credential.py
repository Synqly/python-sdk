...
class SentinelCredential_OAuthClient(UncheckedBaseModel):
...
class SentinelCredential_OAuthClientId(UncheckedBaseModel):
...
SentinelCredential = typing_extensions.Annotated[
    typing.Union[SentinelCredential_OAuthClient, SentinelCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
