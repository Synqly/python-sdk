...
class CopilotChatCredential_OAuthClient(UncheckedBaseModel):
...
class CopilotChatCredential_OAuthClientId(UncheckedBaseModel):
...
CopilotChatCredential = typing_extensions.Annotated[
    typing.Union[CopilotChatCredential_OAuthClient, CopilotChatCredential_OAuthClientId],
