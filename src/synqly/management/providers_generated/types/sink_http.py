...
class SinkHttp(UncheckedBaseModel):
    ...
    accepted_response_codes: typing.Optional[typing.List[int]] = pydantic.Field(default=None)
    """
    ...
    authorization: typing.Optional[HttpReceiverAuthConfig] = pydantic.Field(default=None)
    """
    ...
    request_body_format: typing.Optional[HttpRequestBodyFormat] = pydantic.Field(default=None)
    """
    ...
    signing_credential: typing.Optional[HttpReceiverSigningCredential] = pydantic.Field(default=None)
    """
    ...
    **Warning:** this disables security checks and makes connections vulnerable to man-in-the-middle attacks.
    ...
    static_headers: typing.Optional[typing.Dict[str, str]] = pydantic.Field(default=None)
    """
