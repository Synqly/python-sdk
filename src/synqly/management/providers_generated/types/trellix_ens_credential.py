...
class TrellixEnsCredential_OAuthClient(UncheckedBaseModel):
...
class TrellixEnsCredential_OAuthClientId(UncheckedBaseModel):
...
TrellixEnsCredential = typing_extensions.Annotated[
    typing.Union[TrellixEnsCredential_OAuthClient, TrellixEnsCredential_OAuthClientId],
