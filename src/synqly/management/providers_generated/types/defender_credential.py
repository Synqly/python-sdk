...
class DefenderCredential_OAuthClient(UncheckedBaseModel):
...
class DefenderCredential_OAuthClientId(UncheckedBaseModel):
...
DefenderCredential = typing_extensions.Annotated[
    typing.Union[DefenderCredential_OAuthClient, DefenderCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
