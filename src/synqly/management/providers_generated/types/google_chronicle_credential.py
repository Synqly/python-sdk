...
class GoogleChronicleCredential_OAuthClient(UncheckedBaseModel):
...
class GoogleChronicleCredential_OAuthClientId(UncheckedBaseModel):
...
GoogleChronicleCredential = typing_extensions.Annotated[
    typing.Union[GoogleChronicleCredential_OAuthClient, GoogleChronicleCredential_OAuthClientId],
