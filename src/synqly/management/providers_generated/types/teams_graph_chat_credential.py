...
class TeamsGraphChatCredential_OAuthClient(UncheckedBaseModel):
...
class TeamsGraphChatCredential_OAuthClientId(UncheckedBaseModel):
...
TeamsGraphChatCredential = typing_extensions.Annotated[
    typing.Union[TeamsGraphChatCredential_OAuthClient, TeamsGraphChatCredential_OAuthClientId],
