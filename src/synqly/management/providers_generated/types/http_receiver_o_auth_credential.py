...
class HttpReceiverOAuthCredential_OAuthClient(UncheckedBaseModel):
...
class HttpReceiverOAuthCredential_OAuthClientId(UncheckedBaseModel):
...
HttpReceiverOAuthCredential = typing_extensions.Annotated[
    typing.Union[HttpReceiverOAuthCredential_OAuthClient, HttpReceiverOAuthCredential_OAuthClientId],
