...
class IvantiCredential_OAuthClient(UncheckedBaseModel):
...
class IvantiCredential_OAuthClientId(UncheckedBaseModel):
...
IvantiCredential = typing_extensions.Annotated[
    typing.Union[IvantiCredential_OAuthClient, IvantiCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
