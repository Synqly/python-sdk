...
class SiemSentinel(UncheckedBaseModel):
    ...
    default_tables: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    **Note** that a single `*` entry will map to a `union *` query. Relying heavily on these queries is generally discouraged by Sentinel because they are slower and more resource intensive.
    ...
    ingest_url: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    logs_url: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    management_url: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    workspace_id: str = pydantic_v1.Field()
    """
    ID of the Microsoft Sentinel Log Analytics workspace.
    """

    workspace_name: str = pydantic_v1.Field()
    """
