...
class WorkdayCredential_OAuthClient(UncheckedBaseModel):
...
class WorkdayCredential_OAuthClientId(UncheckedBaseModel):
...
WorkdayCredential = typing_extensions.Annotated[
    typing.Union[WorkdayCredential_OAuthClient, WorkdayCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
