...
class JamfCredential_OAuthClient(UncheckedBaseModel):
...
class JamfCredential_OAuthClientId(UncheckedBaseModel):
...
JamfCredential = typing_extensions.Annotated[
    typing.Union[JamfCredential_OAuthClient, JamfCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
