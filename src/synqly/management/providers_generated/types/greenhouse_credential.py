...
class GreenhouseCredential_OAuthClient(UncheckedBaseModel):
...
class GreenhouseCredential_OAuthClientId(UncheckedBaseModel):
...
GreenhouseCredential = typing_extensions.Annotated[
    typing.Union[GreenhouseCredential_OAuthClient, GreenhouseCredential_OAuthClientId],
