...
class TrimedxCredential_OAuthClient(UncheckedBaseModel):
...
class TrimedxCredential_OAuthClientId(UncheckedBaseModel):
...
TrimedxCredential = typing_extensions.Annotated[
    typing.Union[TrimedxCredential_OAuthClient, TrimedxCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
