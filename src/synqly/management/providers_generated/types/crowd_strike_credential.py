...
class CrowdStrikeCredential_OAuthClient(UncheckedBaseModel):
...
class CrowdStrikeCredential_OAuthClientId(UncheckedBaseModel):
...
CrowdStrikeCredential = typing_extensions.Annotated[
    typing.Union[CrowdStrikeCredential_OAuthClient, CrowdStrikeCredential_OAuthClientId],
