...
class ProviderConfigId(enum.StrEnum):
    """
    ...
    APPSEC_OPEN_TEXT_CORE_APPLICATION_SECURITY_MOCK = "appsec_opentext_core_application_security_mock"
    """
    ...
    ASSETS_TENABLE_CLOUD = "assets_tenable_cloud"
    """
    Tenable Cloud
    """
    ...
    EDR_ESET_CONNECT = "edr_eset_connect"
    """
    ESET Connect
    """
    ...
    EMAIL_SECURITY_MIMECAST_CLOUD_GATEWAY_MOCK = "emailsecurity_mimecast_cloud_gateway_mock"
    """
    ...
    ENDPOINTMANAGEMENT_NINJAONE = "endpointmanagement_ninjaone"
    """
    NinjaOne
    """
    ...
    VULNERABILITIES_AXONIUS = "vulnerabilities_axonius"
    """
    Axonius
    """
    ...
    VULNERABILITIES_CROWD_STRIKE_MOCK = "vulnerabilities_crowdstrike_mock"
    """
    [MOCK] CrowdStrike Falcon® Spotlight
    """
    ...
    VULNERABILITIES_WIZ = "vulnerabilities_wiz"
    """
    Wiz
    """
    ...
    _UNKNOWN = "__PROVIDERCONFIGID_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "ProviderConfigId":
    ...
    def visit(
        ...
        sink_swimlane: typing.Callable[[], T_Result],
        ...
        if self is ProviderConfigId.SINK_SWIMLANE:
            return sink_swimlane()
        ...
        if self is ProviderConfigId.VULNERABILITIES_WIZ:
            return vulnerabilities_wiz()
