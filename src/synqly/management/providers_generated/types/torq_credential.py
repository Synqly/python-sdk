...
class TorqCredential_OAuthClient(UncheckedBaseModel):
...
class TorqCredential_OAuthClientId(UncheckedBaseModel):
...
TorqCredential = typing_extensions.Annotated[
    typing.Union[TorqCredential_OAuthClient, TorqCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
