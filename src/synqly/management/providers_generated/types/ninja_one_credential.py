...
class NinjaOneCredential_OAuthClient(UncheckedBaseModel):
...
class NinjaOneCredential_OAuthClientId(UncheckedBaseModel):
...
NinjaOneCredential = typing_extensions.Annotated[
    typing.Union[NinjaOneCredential_OAuthClient, NinjaOneCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
