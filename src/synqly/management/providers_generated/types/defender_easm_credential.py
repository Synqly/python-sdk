...
class DefenderEasmCredential_OAuthClient(UncheckedBaseModel):
...
class DefenderEasmCredential_OAuthClientId(UncheckedBaseModel):
...
DefenderEasmCredential = typing_extensions.Annotated[
    typing.Union[DefenderEasmCredential_OAuthClient, DefenderEasmCredential_OAuthClientId],
