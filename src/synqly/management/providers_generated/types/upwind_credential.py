...
class UpwindCredential_OAuthClient(UncheckedBaseModel):
...
class UpwindCredential_OAuthClientId(UncheckedBaseModel):
...
UpwindCredential = typing_extensions.Annotated[
    typing.Union[UpwindCredential_OAuthClient, UpwindCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
