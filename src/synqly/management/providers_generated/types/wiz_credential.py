...
class WizCredential_OAuthClient(UncheckedBaseModel):
...
class WizCredential_OAuthClientId(UncheckedBaseModel):
...
WizCredential = typing_extensions.Annotated[
    typing.Union[WizCredential_OAuthClient, WizCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
