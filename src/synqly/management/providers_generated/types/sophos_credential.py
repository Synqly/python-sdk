...
class SophosCredential_OAuthClient(UncheckedBaseModel):
...
class SophosCredential_OAuthClientId(UncheckedBaseModel):
...
SophosCredential = typing_extensions.Annotated[
    typing.Union[SophosCredential_OAuthClient, SophosCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
