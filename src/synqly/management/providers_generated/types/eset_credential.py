...
class EsetCredential_OAuthClient(UncheckedBaseModel):
...
class EsetCredential_OAuthClientId(UncheckedBaseModel):
...
EsetCredential = typing_extensions.Annotated[
    typing.Union[EsetCredential_OAuthClient, EsetCredential_OAuthClientId], UnionMetadata(discriminant="type")
]
