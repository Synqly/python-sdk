...
class WebhookFilter(enum.StrEnum):
    ALL = "all"
    ...
    _UNKNOWN = "__WEBHOOKFILTER_UNKNOWN__"
    """
    This member is used for forward compatibility. If the value is not recognized by the enum, it will be stored here, and the raw value is accessible through `.value`.
    """

    @classmethod
    def _missing_(cls, value: typing.Any) -> "WebhookFilter":
    ...
    def visit(
        ...
        operation_complete: typing.Callable[[], T_Result],
        ...
        if self is WebhookFilter.OPERATION_COMPLETE:
