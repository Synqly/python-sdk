...
class AuthClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(LogonResponse, construct_type(type_=LogonResponse, object_=_response.json()))  # type: ignore
    ...
    def change_password(
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"old_secret": old_secret, "new_secret": new_secret},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ChangePasswordResponse, construct_type(type_=ChangePasswordResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def logoff(self, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/auth/logoff", method="POST", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
