...
class SubOrgsClient:
    ...
    def list(self, *, request_options: typing.Optional[RequestOptions] = None) -> ListOrganizationResponse:
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/suborgs", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListOrganizationResponse, construct_type(type_=ListOrganizationResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/suborgs/{jsonable_encoder(organization_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetOrganizationResponse, construct_type(type_=GetOrganizationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateOrganizationResponse, construct_type(type_=CreateOrganizationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def delete(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/suborgs/{jsonable_encoder(organization_id)}", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
