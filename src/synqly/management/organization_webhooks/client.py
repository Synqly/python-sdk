...
class OrganizationWebhooksClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListOrganizationWebhooksResponse, construct_type(type_=ListOrganizationWebhooksResponse, object_=_response.json()))  # type: ignore
    ...
    def get(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/organization/webhooks/{jsonable_encoder(webhook_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetOrganizationWebhookResponse, construct_type(type_=GetOrganizationWebhookResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateOrganizationWebhookResponse, construct_type(type_=CreateOrganizationWebhookResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateOrganizationWebhookResponse, construct_type(type_=UpdateOrganizationWebhookResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchOrganizationWebhookResponse, construct_type(type_=PatchOrganizationWebhookResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def delete(self, webhook_id: WebhookId, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/organization/webhooks/{jsonable_encoder(webhook_id)}", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
