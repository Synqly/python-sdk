...
class HooksHttpCredential_Token(TokenCredential):
...
class HooksHttpCredential_TokenId(pydantic.BaseModel):
...
HooksHttpCredential = typing.Union[HooksHttpCredential_Token, HooksHttpCredential_TokenId]
