...
class QRadarCredential_Token(TokenCredential):
...
class QRadarCredential_TokenId(pydantic.BaseModel):
...
QRadarCredential = typing.Union[QRadarCredential_Token, QRadarCredential_TokenId]
