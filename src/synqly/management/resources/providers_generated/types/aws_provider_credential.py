...
class AwsProviderCredential_Aws(AwsCredential):
...
class AwsProviderCredential_AwsId(pydantic.BaseModel):
...
AwsProviderCredential = typing.Union[AwsProviderCredential_Aws, AwsProviderCredential_AwsId]
