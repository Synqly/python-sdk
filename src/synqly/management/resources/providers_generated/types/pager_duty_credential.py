...
class PagerDutyCredential_Token(TokenCredential):
...
class PagerDutyCredential_TokenId(pydantic.BaseModel):
...
PagerDutyCredential = typing.Union[PagerDutyCredential_Token, PagerDutyCredential_TokenId]
