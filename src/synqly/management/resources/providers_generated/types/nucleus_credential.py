...
class NucleusCredential_Token(TokenCredential):
...
class NucleusCredential_TokenId(pydantic.BaseModel):
...
NucleusCredential = typing.Union[NucleusCredential_Token, NucleusCredential_TokenId]
