...
class FreshdeskCredential_Token(TokenCredential):
...
class FreshdeskCredential_TokenId(pydantic.BaseModel):
...
FreshdeskCredential = typing.Union[FreshdeskCredential_Token, FreshdeskCredential_TokenId]
