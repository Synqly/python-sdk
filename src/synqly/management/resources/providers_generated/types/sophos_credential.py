...
class SophosCredential_OAuthClient(OAuthClientCredential):
...
class SophosCredential_OAuthClientId(pydantic.BaseModel):
...
SophosCredential = typing.Union[SophosCredential_OAuthClient, SophosCredential_OAuthClientId]
