...
class TenableCloudCredential_Token(TokenCredential):
...
class TenableCloudCredential_TokenId(pydantic.BaseModel):
...
TenableCloudCredential = typing.Union[TenableCloudCredential_Token, TenableCloudCredential_TokenId]
