...
class SentinelCredential_OAuthClient(OAuthClientCredential):
...
class SentinelCredential_OAuthClientId(pydantic.BaseModel):
...
SentinelCredential = typing.Union[SentinelCredential_OAuthClient, SentinelCredential_OAuthClientId]
