...
class SevcoCredential_Token(TokenCredential):
...
class SevcoCredential_TokenId(pydantic.BaseModel):
...
SevcoCredential = typing.Union[SevcoCredential_Token, SevcoCredential_TokenId]
