...
class SumoLogicCredential_Basic(BasicCredential):
...
class SumoLogicCredential_BasicId(pydantic.BaseModel):
...
SumoLogicCredential = typing.Union[SumoLogicCredential_Basic, SumoLogicCredential_BasicId]
