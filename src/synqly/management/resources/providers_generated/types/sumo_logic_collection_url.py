...
class SumoLogicCollectionUrl_Secret(SecretCredential):
...
class SumoLogicCollectionUrl_SecretId(pydantic.BaseModel):
...
SumoLogicCollectionUrl = typing.Union[SumoLogicCollectionUrl_Secret, SumoLogicCollectionUrl_SecretId]
