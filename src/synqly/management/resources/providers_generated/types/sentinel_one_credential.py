...
class SentinelOneCredential_Token(TokenCredential):
...
class SentinelOneCredential_TokenId(pydantic.BaseModel):
...
SentinelOneCredential = typing.Union[SentinelOneCredential_Token, SentinelOneCredential_TokenId]
