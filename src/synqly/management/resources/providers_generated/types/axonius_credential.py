...
class AxoniusCredential_Basic(BasicCredential):
...
class AxoniusCredential_BasicId(pydantic.BaseModel):
...
AxoniusCredential = typing.Union[AxoniusCredential_Basic, AxoniusCredential_BasicId]
