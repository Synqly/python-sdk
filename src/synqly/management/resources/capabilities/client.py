...
class CapabilitiesClient:
    ...
    def list_connectors(self, *, expand: typing.Optional[typing.Union[ListConnectorCapabilitiesExpandOptions, typing.Sequence[ListConnectorCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ListConnectorsCapabilitiesResponse:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/capabilities/connectors"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
    ...
    def list_providers(self, *, expand: typing.Optional[typing.Union[ListProviderCapabilitiesExpandOptions, typing.Sequence[ListProviderCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ListProvidersCapabilitiesResponse:
        """
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/capabilities/providers"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    def get_provider(self, provider_id: ProviderConfigId, *, expand: typing.Optional[typing.Union[GetProviderCapabilitiesExpandOptions, typing.Sequence[GetProviderCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ProviderCapabilitiesResponse:
        """
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"v1/capabilities/providers/{jsonable_encoder(provider_id)}"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
...
class AsyncCapabilitiesClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def list_connectors(self, *, expand: typing.Optional[typing.Union[ListConnectorCapabilitiesExpandOptions, typing.Sequence[ListConnectorCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ListConnectorsCapabilitiesResponse:
        """
        Returns a list of all `Connectors`.
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = await self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/capabilities/connectors"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    async def list_providers(self, *, expand: typing.Optional[typing.Union[ListProviderCapabilitiesExpandOptions, typing.Sequence[ListProviderCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ListProvidersCapabilitiesResponse:
        """
        Returns a list of all Provider capabilities and their configurations.
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = await self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/capabilities/providers"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
        ...
        try:
            ...
            raise ApiError(status_code=_response.status_code, body=_response.text)
        raise ApiError(status_code=_response.status_code, body=_response_json)
    async def get_provider(self, provider_id: ProviderConfigId, *, expand: typing.Optional[typing.Union[GetProviderCapabilitiesExpandOptions, typing.Sequence[GetProviderCapabilitiesExpandOptions]]] = None, request_options: typing.Optional[RequestOptions] = None) -> ProviderCapabilitiesResponse:
        """
        Returns the capabilities and configurations for a specific Provider type
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = await self._client_wrapper.httpx_client.request("GET", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", f"v1/capabilities/providers/{jsonable_encoder(provider_id)}"), 
            params=jsonable_encoder(remove_none_from_dict({"expand": expand, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
            )),
