...
_dynamic_imports: typing.Dict[str, str] = {
    "OperationFrequency": ".operation_frequency",
    "OperationFrequencyPeriodic": ".operation_frequency_periodic",
    "OperationFrequency_Periodic": ".operation_frequency",
    "OperationIncrementalPullConfig": ".operation_incremental_pull_config",
    "OperationIncrementalPullMode": ".operation_incremental_pull_mode",
