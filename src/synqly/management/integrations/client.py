...
class IntegrationsClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListIntegrationsResponse, construct_type(type_=ListIntegrationsResponse, object_=_response.json()))  # type: ignore
    ...
    def list_account(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListAccountIntegrationsResponse, construct_type(type_=ListAccountIntegrationsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetIntegrationResponse, construct_type(type_=GetIntegrationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateIntegrationResponse, construct_type(type_=CreateIntegrationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UpdateIntegrationResponse, construct_type(type_=UpdateIntegrationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def patch(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(PatchIntegrationResponse, construct_type(type_=PatchIntegrationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
