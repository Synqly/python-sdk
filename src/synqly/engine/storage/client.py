...
class StorageClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListStorageResponse, construct_type(type_=ListStorageResponse, object_=_response.json()))  # type: ignore
    ...
    def download_file(
        ...
        with self._client_wrapper.httpx_client.stream(
            f"v1/storage/files/{jsonable_encoder(path)}", method="GET", request_options=request_options
        ) as _response:
            try:
                if 200 <= _response.status_code < 300:
    ...
    def delete_file(self, path: str, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/storage/files/{jsonable_encoder(path)}", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
