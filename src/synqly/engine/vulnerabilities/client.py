...
class VulnerabilitiesClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryFindingsResponse, construct_type(type_=QueryFindingsResponse, object_=_response.json()))  # type: ignore
    ...
    def create_findings(
        self, *, findings: typing.Sequence[SecurityFinding], request_options: typing.Optional[RequestOptions] = None
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateFindingsResponse, construct_type(type_=CreateFindingsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update_finding(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="PUT",
            json={"severity_id": severity_id, "severity": severity, "state": state, "unmapped": unmapped},
            request_options=request_options,
            omit=OMIT,
        )
        try:
    ...
    def query_assets(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryAssetsResponse, construct_type(type_=QueryAssetsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create_asset(
        self, *, asset: Asset, source_name: str, request_options: typing.Optional[RequestOptions] = None
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/vulnerabilities/assets",
            method="POST",
            json={"asset": asset, "source_name": source_name},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(typing.Optional[CreateAssetResponse], construct_type(type_=typing.Optional[CreateAssetResponse], object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def update_asset(
        self, asset_id: str, *, asset: Asset, source_name: str, request_options: typing.Optional[RequestOptions] = None
    ) -> Asset:
        """
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(Asset, construct_type(type_=Asset, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_scans(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={"meta": meta, "limit": limit, "cursor": cursor},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryScansResponse, construct_type(type_=QueryScansResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_scan_activity(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetScanActivityResponse, construct_type(type_=GetScanActivityResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def upload_scan(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/vulnerabilities/scans",
            method="POST",
            json={"assets": assets, "source_name": source_name},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(UploadScanResponse, construct_type(type_=UploadScanResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
