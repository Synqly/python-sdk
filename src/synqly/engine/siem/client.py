...
class SiemClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryInvestigationResponse, construct_type(type_=QueryInvestigationResponse, object_=_response.json()))  # type: ignore
    ...
    def get_investigation(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={"meta": meta, "include_raw_data": include_raw_data},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetInvestigationResponse, construct_type(type_=GetInvestigationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_evidence(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetEvidenceResponse, construct_type(type_=GetEvidenceResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_log_providers(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={"meta": meta, "cursor": cursor, "limit": limit},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryLogProvidersResponse, construct_type(type_=QueryLogProvidersResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def post_events(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/siem/events", method="POST", json=request, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                return
    ...
    def query_events(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QuerySiemEventsResponse, construct_type(type_=QuerySiemEventsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_alerts(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QuerySiemAlertsResponse, construct_type(type_=QuerySiemAlertsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
