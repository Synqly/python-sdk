...
class AppsecClient:
    ...
    def query_applications(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="GET",
            params={"meta": meta, "limit": limit, "order": order, "filter": filter, "cursor": cursor},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(AppSecQueryApplicationsResponse, construct_type(type_=AppSecQueryApplicationsResponse, object_=_response.json()))  # type: ignore
    ...
    def query_application_findings(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(AppSecQueryApplicationFindingsResponse, construct_type(type_=AppSecQueryApplicationFindingsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_findings(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/app-sec/findings",
            method="GET",
            params={"filter": filter, "limit": limit, "cursor": cursor},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(AppSecQueryFindingsResponse, construct_type(type_=AppSecQueryFindingsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_application_finding_details(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(AppSecGetApplicationFindingDetailsResponse, construct_type(type_=AppSecGetApplicationFindingDetailsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
