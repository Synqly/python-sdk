...
class Ticket(Base):
    ...
    project: typing.Optional[ProjectId] = pydantic_v1.Field(default=None)
    """
    The ticket project.
    """

    issue_type: typing.Optional[IssueTypeId] = pydantic_v1.Field(default=None)
    """
    The ticket's type.
    """
    ...
    attachments: typing.Optional[typing.List[AttachmentMetadata]] = pydantic_v1.Field(default=None)
    """
