...
class RawCloudsecurityClient:
    ...
    ) -> HttpResponse[QueryEventsResponse]:
        """
    ...
    def query_ioms(
        ...
        *,
        ...
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryIomsResponse]:
        """
    ...
    def query_cloud_resource_inventory(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryCloudResourceInventoryResponse]:
        """
    ...
    def query_compliance_findings(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryComplianceFindingsResponse]:
        """
    ...
    def query_threats(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryCloudSecurityThreatsResponse]:
        """
...
class AsyncRawCloudsecurityClient:
    ...
    async def query_events(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryEventsResponse]:
        """
        Returns a list of events that match the query from the cloud security provider.
    ...
    async def query_ioms(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryIomsResponse]:
        """
        Returns a list of Indicators of Misconfiguration (IOM) findings that match the query from the cloud security provider.
    ...
    async def query_cloud_resource_inventory(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryCloudResourceInventoryResponse]:
        """
        Returns a list of cloud resources that match the query from the cloud security provider.
    ...
    async def query_compliance_findings(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryComplianceFindingsResponse]:
        """
        Returns a list of compliance findings matching the query from the cloud security provider.
    ...
    async def query_threats(
        ...
        *,
        ...
        include_raw_data: typing.Optional[bool] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryCloudSecurityThreatsResponse]:
        """
        Returns a list of threat detections that match the query from the cloud security provider.
