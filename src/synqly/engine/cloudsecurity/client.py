...
class CloudsecurityClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryEventsResponse, construct_type(type_=QueryEventsResponse, object_=_response.json()))  # type: ignore
    ...
    def query_ioms(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryIomsResponse, construct_type(type_=QueryIomsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_cloud_resource_inventory(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryCloudResourceInventoryResponse, construct_type(type_=QueryCloudResourceInventoryResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_compliance_findings(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryComplianceFindingsResponse, construct_type(type_=QueryComplianceFindingsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
