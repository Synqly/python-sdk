...
class CustomClient:
    ...
    def query(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/query/{jsonable_encoder(operation)}",
            method="GET",
            params={
                "meta": meta,
                "cursor": cursor,
    ...
    def get(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/get/{jsonable_encoder(operation)}/{jsonable_encoder(id)}",
            method="GET",
            params={
                "meta": meta,
                "include_raw_data": include_raw_data,
    ...
    def patch(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/patch/{jsonable_encoder(operation)}/{jsonable_encoder(id)}",
            method="PATCH",
            json=request,
            request_options=request_options,
            omit=OMIT,
    ...
    def delete(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/delete/{jsonable_encoder(operation)}/{jsonable_encoder(id)}",
            method="DELETE",
            request_options=request_options,
        )
        try:
    ...
    def post(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/post/{jsonable_encoder(operation)}",
            method="POST",
            json=request,
            request_options=request_options,
            omit=OMIT,
    ...
    def post_batch(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/custom/operations/post-batch/{jsonable_encoder(operation)}",
            method="POST",
            json=request,
            request_options=request_options,
            omit=OMIT,
