...
class NotificationsClient:
    ...
    def get_message(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/notifications/get/{jsonable_encoder(notification_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetNotificationResponse, construct_type(type_=GetNotificationResponse, object_=_response.json()))  # type: ignore
    ...
    def create_message(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateNotificationResponse, construct_type(type_=CreateNotificationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def clear_message(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/notifications/clear/{jsonable_encoder(notification_id)}",
            method="POST",
            request_options=request_options,
        )
        try:
