...
class HooksClient:
    ...
    def proxy(self, *, meta: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None, token: str, request: typing.Any, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/hooks"), 
            params=jsonable_encoder(remove_none_from_dict({"meta": meta, "token": token, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
...
class AsyncHooksClient:
    def __init__(self, *, client_wrapper: AsyncClientWrapper):
        self._client_wrapper = client_wrapper
    async def proxy(self, *, meta: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None, token: str, request: typing.Any, request_options: typing.Optional[RequestOptions] = None) -> None:
        """
        Proxy webhook messages from webhook providers to webhook recievers. For exact webhook implementations please refer to providers e.g. Ticketing. This is just an API call used in that context, not a standalone implementation.
        ...
        Parameters:
            ...
            - request_options: typing.Optional[RequestOptions]. Request-specific configuration.
        """
        _response = await self._client_wrapper.httpx_client.request("POST", urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/hooks"), 
            params=jsonable_encoder(remove_none_from_dict({"meta": meta, "token": token, **(request_options.get('additional_query_parameters', {}) if request_options is not None else {}),},
            )),
            json=jsonable_encoder(request) if request_options is None or request_options.get('additional_body_parameters') is None else {**jsonable_encoder(request), **(jsonable_encoder(remove_none_from_dict(request_options.get('additional_body_parameters', {}))))},
            headers=jsonable_encoder(remove_none_from_dict({**self._client_wrapper.get_headers(),**(request_options.get('additional_headers', {}) if request_options is not None else {}),},
