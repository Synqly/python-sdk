...
class CloudsecurityClient:
    ...
    def query_ioms(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/cloudsecurity/ioms"),
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(QueryIomsResponse, _response.json())  # type: ignore
    ...
    def query_cloud_resource_inventory(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/cloudsecurity/cloudresourcesinventory"),
            params=jsonable_encoder(
                remove_none_from_dict(
                    {
                        "meta": meta,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(QueryCloudResourceInventoryResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(Problem, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(Problem, _response.json()))  # type: ignore
    ...
    def query_compliance_findings(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "GET",
            urllib.parse.urljoin(f"{self._client_wrapper.get_base_url()}/", "v1/cloudsecurity/compliancefindings"),
            params=jsonable_encoder(
                remove_none_from_dict(
                    {
                        "meta": meta,
        ...
        if 200 <= _response.status_code < 300:
            return pydantic.parse_obj_as(QueryComplianceFindingsResponse, _response.json())  # type: ignore
        if _response.status_code == 400:
            raise BadRequestError(pydantic.parse_obj_as(Problem, _response.json()))  # type: ignore
        if _response.status_code == 401:
            raise UnauthorizedError(pydantic.parse_obj_as(Problem, _response.json()))  # type: ignore
