...
class ProblemContext(UncheckedBaseModel):
    parameter: typing.Optional[ProblematicParameter] = pydantic_v1.Field(default=None)
    """
    ...
    raw_error: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    If available this represents the underlying raw error, for example an error response from a Provider.
    """

    provider_details: typing.Optional[typing.Dict[str, str]] = pydantic_v1.Field(default=None)
    """
