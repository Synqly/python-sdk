...
class IdentityClient:
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryIdentityAuditLogResponse, construct_type(type_=QueryIdentityAuditLogResponse, object_=_response.json()))  # type: ignore
    ...
    def query_users(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryUsersResponse, construct_type(type_=QueryUsersResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_user(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetUserResponse, construct_type(type_=GetUserResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_groups(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryGroupsResponse, construct_type(type_=QueryGroupsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_group(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/identity/groups/{jsonable_encoder(group_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetGroupResponse, construct_type(type_=GetGroupResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_group_members(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetGroupMembersResponse, construct_type(type_=GetGroupMembersResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
