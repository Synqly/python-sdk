...
class OperationsClient:
    ...
    def get(
        ...
        _response = self._client_wrapper.httpx_client.request(
            f"v1/operations/{jsonable_encoder(operation_id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetOperationResponse, construct_type(type_=GetOperationResponse, object_=_response.json()))  # type: ignore
    ...
    def create(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/operations",
            method="POST",
            json={"schedule": schedule, "operation": operation, "input": input},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateOperationResponse, construct_type(type_=CreateOperationResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def cancel(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/operations/{jsonable_encoder(operation_id)}", method="POST", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
