...
class NetworkProxy(UncheckedBaseModel):
    ...
    intermediate_ips: typing.Optional[typing.List[IpAddress]] = pydantic_v1.Field(default=None)
    """
    ...
    isp: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The name of the Internet Service Provider (ISP).
    """

    isp_org: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    proxy_endpoint: typing.Optional[Object] = pydantic_v1.Field(default=None)
    """
    ...
    svc_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    type_id: typing.Optional[NetworkProxyTypeId] = pydantic_v1.Field(default=None)
    """
