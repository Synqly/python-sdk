...
class Advisory(UncheckedBaseModel):
    ...
    install_state_id: typing.Optional[AdvisoryInstallStateId] = pydantic_v1.Field(default=None)
    """
    ...
    related_cves: typing.Optional[typing.List[Cve]] = pydantic_v1.Field(default=None)
    """
    ...
    related_cwes: typing.Optional[typing.List[Cwe]] = pydantic_v1.Field(default=None)
    """
