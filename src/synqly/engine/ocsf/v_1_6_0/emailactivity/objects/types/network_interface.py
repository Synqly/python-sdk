...
class NetworkInterface(UncheckedBaseModel):
    ...
    open_ports: typing.Optional[typing.List[PortInfo]] = pydantic_v1.Field(default=None)
    """
    The list of open ports on a network interface, including port numbers and associated protocol information.
    """

    subnet_prefix: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    type_id: typing.Optional[NetworkInterfaceTypeId] = pydantic_v1.Field(default=None)
    """
