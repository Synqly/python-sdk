...
class AffectedPackage(UncheckedBaseModel):
    ...
    license_url: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    ...
    package_manager_url: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    ...
    path: typing.Optional[FilePath] = pydantic_v1.Field(default=None)
    """
