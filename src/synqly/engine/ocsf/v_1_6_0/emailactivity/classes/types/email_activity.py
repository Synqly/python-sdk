...
class EmailActivity(UncheckedBaseModel):
    ...
    attempt: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    banner: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    command: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    direction_id: DirectionId = pydantic_v1.Field()
    """
    ...
    message_trace_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    smtp_hello: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    to: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
