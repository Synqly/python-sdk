...
class HttpRequest(UncheckedBaseModel):
    ...
    args: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    http_method: typing.Optional[HttpRequestHttpMethod] = pydantic_v1.Field(default=None)
    """
    ...
    referrer: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    user_agent_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    x_forwarded_for: typing.Optional[typing.List[IpAddress]] = pydantic_v1.Field(default=None)
    """
