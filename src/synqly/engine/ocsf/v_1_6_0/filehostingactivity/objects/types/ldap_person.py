...
class LdapPerson(UncheckedBaseModel):
    ...
    cost_center: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    deleted_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    ...
    deleted_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The timestamp when the user was deleted. In Active Directory (AD), when a user is deleted they are moved to a temporary container and then removed after 30 days. So, this field can be populated even after a user is deleted for the next 30 days.
    """

    display_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    email_addrs: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
    A list of additional email addresses for the user.
    """

    employee_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The employee identifier assigned to the user by the organization.
    """

    given_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The given or first name of the user.
    """

    hire_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The timestamp when the user was or will be hired by the organization.
    """

    hire_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The timestamp when the user was or will be hired by the organization.
    """

    job_title: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    last_login_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The last time when the user logged in.
    """

    last_login_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The last time when the user logged in.
    """

    ldap_cn: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The LDAP and X.500 <code>commonName</code> attribute, typically the full name of the person. For example, <code>John Doe</code>.
    """

    ldap_dn: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    leave_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The timestamp when the user left or will be leaving the organization.
    """

    leave_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The timestamp when the user left or will be leaving the organization.
    """
    ...
    manager: typing.Optional[Object] = pydantic_v1.Field(default=None)
    """
    ...
    office_location: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    surname: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
