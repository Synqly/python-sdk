...
class Process(UncheckedBaseModel):
    ...
    ancestry: typing.Optional[typing.List[ProcessEntity]] = pydantic_v1.Field(default=None)
    """
    ...
    auid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    egid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    The effective group under which this process is running.
    """

    environment_variables: typing.Optional[typing.List[EnvironmentVariable]] = pydantic_v1.Field(default=None)
    """
    Environment variables associated with the process.
    """

    euid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    integrity: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    integrity_id: typing.Optional[ProcessIntegrityId] = pydantic_v1.Field(default=None)
    """
    The normalized identifier of the process integrity level (Windows only).
    """

    lineage: typing.Optional[typing.List[FilePath]] = pydantic_v1.Field(default=None)
    """
    ...
    loaded_modules: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    parent_process: typing.Optional[Object] = pydantic_v1.Field(default=None)
    """
    ...
    ptid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    The identifier of the process thread associated with the event, as returned by the operating system.
    """

    sandbox: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    terminated_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The time when the process was terminated.
    """

    terminated_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The time when the process was terminated.
    """

    tid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    working_directory: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
