...
class Sso(UncheckedBaseModel):
    ...
    auth_protocol_id: typing.Optional[SsoAuthProtocolId] = pydantic_v1.Field(default=None)
    """
    ...
    idle_timeout: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    Duration (in minutes) of allowed inactivity before Single Sign-On (SSO) session expiration.
    """

    login_endpoint: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    URL for initiating an SSO login request.
    """

    logout_endpoint: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    URL for initiating an SSO logout request, allowing sessions to be terminated across applications.
    """

    metadata_endpoint: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    ...
    scopes: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
