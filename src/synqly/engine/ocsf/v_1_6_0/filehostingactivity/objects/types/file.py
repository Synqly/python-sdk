...
class File(UncheckedBaseModel):
    ...
    drive_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    drive_type_id: typing.Optional[FileDriveTypeId] = pydantic_v1.Field(default=None)
    """
    Identifies the type of a disk drive, i.e. fixed, removable, etc.
    """

    encryption_details: typing.Optional[EncryptionDetails] = pydantic_v1.Field(default=None)
    """
    ...
    internal_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    is_encrypted: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    is_readonly: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    storage_class: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    uri: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    ...
    volume: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
