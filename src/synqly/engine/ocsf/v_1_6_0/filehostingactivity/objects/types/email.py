...
class Email(UncheckedBaseModel):
    ...
    cc_mailboxes: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    delivered_to_list: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
    ...
    from_list: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
    ...
    from_mailbox: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The human-readable email header From Mailbox value. For example <code>'Example User &lt;example.user@usersdomain.com&gt;'</code>.
    """

    from_mailboxes: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
    ...
    is_read: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    reply_to_list: typing.Optional[typing.List[EmailAddress]] = pydantic_v1.Field(default=None)
    """
    ...
    reply_to_mailboxes: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    The human-readable email header Reply To Mailbox values. For example <code>'Example User &lt;example.user@usersdomain.com&gt;'</code>.
    """

    return_path: typing.Optional[EmailAddress] = pydantic_v1.Field(default=None)
    """
    ...
    sender: typing.Optional[EmailAddress] = pydantic_v1.Field(default=None)
    """
    ...
    sender_mailbox: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    to_mailboxes: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
