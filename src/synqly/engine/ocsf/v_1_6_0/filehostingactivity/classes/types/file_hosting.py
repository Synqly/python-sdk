...
class FileHosting(UncheckedBaseModel):
    ...
    access_list: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    The list of requested access rights.
    """

    access_mask: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    The sum of hexadecimal values of requested access rights.
    """

    access_result: typing.Optional[typing.Any] = pydantic_v1.Field(default=None)
    """
    ...
    file_result: typing.Optional[File] = pydantic_v1.Field(default=None)
    """
    ...
    share: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The share name.
    """

    share_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    share_type_id: typing.Optional[ShareTypeId] = pydantic_v1.Field(default=None)
    """
    The normalized identifier of the share type.
    """

    src_endpoint: NetworkEndpoint = pydantic_v1.Field()
    """
