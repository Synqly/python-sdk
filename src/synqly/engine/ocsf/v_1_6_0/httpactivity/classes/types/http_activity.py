...
from ...objects.types.http_cookie import HttpCookie
...
class HttpActivity(UncheckedBaseModel):
    """
    HTTP Activity events report HTTP connection and traffic information.
    """

    action: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The normalized caption of <code>action_id</code>.
    """

    action_id: typing.Optional[ActionId] = pydantic_v1.Field(default=None)
    """
    ...
    confidence: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The confidence, normalized to the caption of the confidence_id value. In the case of 'Other', it is defined by the event source.
    """

    confidence_id: typing.Optional[ConfidenceId] = pydantic_v1.Field(default=None)
    """
    The normalized confidence refers to the accuracy of the rule that created the finding. A rule with a low confidence means that the finding scope is wide and may create finding reports that may not be malicious in nature.
    """

    confidence_score: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    disposition: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    disposition_id: typing.Optional[DispositionId] = pydantic_v1.Field(default=None)
    """
    ...
    firewall_rule: typing.Optional[FirewallRule] = pydantic_v1.Field(default=None)
    """
    The firewall rule that pertains to the control that triggered the event, if applicable.
    """

    http_cookies: typing.Optional[typing.List[HttpCookie]] = pydantic_v1.Field(default=None)
    """
    ...
    http_status: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    is_alert: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    ja_4_fingerprint_list: typing.Optional[typing.List[Ja4Fingerprint]] = pydantic_v1.Field(
        alias="ja4_fingerprint_list", default=None
    )
    """
    A list of the JA4+ network fingerprints.
    """

    load_balancer: typing.Optional[LoadBalancer] = pydantic_v1.Field(default=None)
    """
    ...
    malware: typing.Optional[typing.List[Malware]] = pydantic_v1.Field(default=None)
    """
    A list of Malware objects, describing details about the identified malware.
    """

    malware_scan_info: typing.Optional[MalwareScanInfo] = pydantic_v1.Field(default=None)
    """
    ...
    proxy: typing.Optional[NetworkProxy] = pydantic_v1.Field(default=None)
    """
    The proxy (server) in a network connection.
    """

    proxy_connection_info: typing.Optional[NetworkConnectionInfo] = pydantic_v1.Field(default=None)
    """
    The connection information from the proxy server to the remote server.
    """

    proxy_endpoint: typing.Optional[NetworkProxy] = pydantic_v1.Field(default=None)
    """
    The proxy (server) in a network connection.
    """

    proxy_http_request: typing.Optional[HttpRequest] = pydantic_v1.Field(default=None)
    """
    The HTTP Request from the proxy server to the remote server.
    """

    proxy_http_response: typing.Optional[HttpResponse] = pydantic_v1.Field(default=None)
    """
    The HTTP Response from the remote server to the proxy server.
    """

    proxy_tls: typing.Optional[Tls] = pydantic_v1.Field(default=None)
    """
    The TLS protocol negotiated between the proxy server and the remote server.
    """

    proxy_traffic: typing.Optional[NetworkTraffic] = pydantic_v1.Field(default=None)
    """
    ...
    raw_data_hash: typing.Optional[Fingerprint] = pydantic_v1.Field(default=None)
    """
    The hash, which describes the content of the raw_data field.
    """

    raw_data_size: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    The size of the raw data which was transformed into an OCSF event, in bytes.
    """

    risk_details: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    risk_level_id: typing.Optional[RiskLevelId] = pydantic_v1.Field(default=None)
    """
    ...
    traffic: typing.Optional[NetworkTraffic] = pydantic_v1.Field(default=None)
    """
