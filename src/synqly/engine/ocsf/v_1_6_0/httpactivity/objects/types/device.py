...
class Device(UncheckedBaseModel):
    ...
    agent_list: typing.Optional[typing.List[Agent]] = pydantic_v1.Field(default=None)
    """
    A list of <code>agent</code> objects associated with a device, endpoint, or resource.
    """

    autoscale_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The unique identifier of the cloud autoscale configuration.
    """

    boot_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The time the system was booted.
    """

    boot_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The time the system was booted.
    """

    boot_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    eid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    hw_info: typing.Optional[DeviceHwInfo] = pydantic_v1.Field(default=None)
    """
    The endpoint hardware information.
    """

    hypervisor: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    iccid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    image: typing.Optional[Image] = pydantic_v1.Field(default=None)
    """
    The image used as a template to run the virtual machine.
    """

    imei: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The International Mobile Equipment Identity that is associated with the device.
    """

    imei_list: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    The International Mobile Equipment Identity values that are associated with the device.
    """

    instance_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The unique identifier of a VM instance.
    """

    interface_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The name of the network interface (e.g. eth2).
    """

    interface_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    ip_addresses: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    A list of IP addresses available on the device
    """

    is_backed_up: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    is_compliant: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    The event occurred on a compliant device.
    """

    is_managed: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    The event occurred on a managed device.
    """

    is_mobile_account_active: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    is_shared: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    The event occurred on a shared device.
    """

    is_supervised: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    is_trusted: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    mac: typing.Optional[MacAddress] = pydantic_v1.Field(default=None)
    """
    The Media Access Control (MAC) address of the endpoint.
    """

    mac_addresses: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    A list of MAC addresses available on the device
    """

    meid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    namespace_pid: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    If running under a process namespace (such as in a container), the process identifier within that process namespace.
    """

    netbios_names: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    A list of NetBIOS names available on the device
    """

    network_interfaces: typing.Optional[typing.List[NetworkInterface]] = pydantic_v1.Field(default=None)
    """
    ...
    network_status: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The network isolation status of the endpoint
    """

    network_status_id: typing.Optional[DeviceNetworkStatusId] = pydantic_v1.Field(default=None)
    """
    ...
    os_machine_uuid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    risk_level: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The risk level, normalized to the caption of the risk_level_id value.
    """

    risk_level_id: typing.Optional[DeviceRiskLevelId] = pydantic_v1.Field(default=None)
    """
    The normalized risk level id.
    """

    risk_score: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    subnet_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The unique identifier of a virtual subnet.
    """

    sw_info: typing.Optional[typing.List[Product]] = pydantic_v1.Field(default=None)
    """
    ...
    type_id: DeviceTypeId = pydantic_v1.Field()
    """
    The device type ID.
    """

    udid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    vendor: typing.Optional[Organization] = pydantic_v1.Field(default=None)
    """
    ...
    vlan_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The Virtual LAN identifier.
    """

    vpc_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
