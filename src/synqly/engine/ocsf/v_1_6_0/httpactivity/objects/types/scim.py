...
class Scim(UncheckedBaseModel):
    ...
    auth_protocol_id: typing.Optional[ScimAuthProtocolId] = pydantic_v1.Field(default=None)
    """
    ...
    is_group_provisioning_enabled: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    Indicates whether the SCIM resource is configured to provision groups, automatically or otherwise.
    """

    is_user_provisioning_enabled: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    rate_limit: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    Maximum number of requests allowed by the SCIM resource within a specified time frame to avoid throttling.
    """

    scim_group_schema: typing.Optional[typing.Any] = pydantic_v1.Field(default=None)
    """
    ...
    scim_user_schema: typing.Optional[typing.Any] = pydantic_v1.Field(default=None)
    """
    ...
    state_id: typing.Optional[ScimStateId] = pydantic_v1.Field(default=None)
    """
