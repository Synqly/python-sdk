...
class Logger(UncheckedBaseModel):
    ...
    event_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    transmit_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The time when the event was transmitted from the logging device to it's next destination.
    """

    transmit_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The time when the event was transmitted from the logging device to it's next destination.
    """
