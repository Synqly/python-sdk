...
class AnomalyAnalysis(UncheckedBaseModel):
    ...
    analysis_targets: typing.List[AnalysisTarget] = pydantic.Field()
    """
    ...
    anomalies: typing.List[Anomaly] = pydantic.Field()
    """
    ...
    baselines: typing.Optional[typing.List[Baseline]] = pydantic.Field(default=None)
    """
