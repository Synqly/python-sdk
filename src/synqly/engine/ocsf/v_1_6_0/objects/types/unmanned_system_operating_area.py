...
class UnmannedSystemOperatingArea(UncheckedBaseModel):
    """
    ...
    altitude_ceiling: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    altitude_floor: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    radius: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    type_id: typing.Optional[UnmannedSystemOperatingAreaTypeId] = pydantic.Field(default=None)
    """
