...
class ComplianceFinding(UncheckedBaseModel):
    """
    ...
    compliance: Compliance = pydantic_v1.Field()
    """
    ...
    resource: typing.Optional[ResourceDetails] = pydantic_v1.Field(default=None)
    """
