...
class LdapPerson(UncheckedBaseModel):
    ...
    employment_status_date_dt: typing.Optional[dt.datetime] = pydantic.Field(default=None)
    """
    The timestamp when the employment status was last changed.
    """

    employment_status_id: typing.Optional[LdapPersonEmploymentStatusId] = pydantic.Field(default=None)
    """
