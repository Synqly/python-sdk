...
from ...objects.types.managed_entity import ManagedEntity
...
class EntityManagement(UncheckedBaseModel):
    """
    ...
    entity: ManagedEntity = pydantic_v1.Field()
    """
    The managed entity that is being acted upon.
    """

    entity_result: typing.Optional[ManagedEntity] = pydantic_v1.Field(default=None)
    """
