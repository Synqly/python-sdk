...
class ProcessActivity(UncheckedBaseModel):
    """
    ...
    actual_permissions: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    device: Device = pydantic_v1.Field()
    """
    ...
    exit_code: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    injection_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    injection_type_id: typing.Optional[InjectionTypeId] = pydantic_v1.Field(default=None)
    """
    ...
    module: typing.Optional[Module] = pydantic_v1.Field(default=None)
    """
    ...
    process: Process = pydantic_v1.Field()
    """
    ...
    requested_permissions: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
