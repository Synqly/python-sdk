...
class Module(UncheckedBaseModel):
    ...
    base_address: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    function_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
