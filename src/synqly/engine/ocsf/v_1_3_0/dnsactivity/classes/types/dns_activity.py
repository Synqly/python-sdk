...
class DnsActivity(UncheckedBaseModel):
    """
    ...
    query_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The Domain Name System (DNS) query time.
    """

    query_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The Domain Name System (DNS) query time.
    """
    ...
    rcode: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    rcode_id: typing.Optional[RcodeId] = pydantic_v1.Field(default=None)
    """
    ...
    response_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The Domain Name System (DNS) response time.
    """

    response_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The Domain Name System (DNS) response time.
    """
