...
class DnsQuery(UncheckedBaseModel):
    ...
    hostname: Hostname = pydantic_v1.Field()
    """
    The hostname or domain being queried. For example: <code>www.example.com</code>
    """

    opcode: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The DNS opcode specifies the type of the query message.
    """

    opcode_id: typing.Optional[DnsQueryOpcodeId] = pydantic_v1.Field(default=None)
    """
