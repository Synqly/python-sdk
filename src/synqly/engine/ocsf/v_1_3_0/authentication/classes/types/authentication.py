...
from ...objects.types.auth_factor import AuthFactor
...
class Authentication(UncheckedBaseModel):
    """
    ...
    auth_factors: typing.Optional[typing.List[AuthFactor]] = pydantic_v1.Field(default=None)
    """
    Describes a category of methods used for identity verification in an authentication attempt.
    """

    auth_protocol: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    auth_protocol_id: typing.Optional[AuthProtocolId] = pydantic_v1.Field(default=None)
    """
    ...
    is_cleartext: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    is_new_logon: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    logon_process: typing.Optional[Process] = pydantic_v1.Field(default=None)
    """
    The trusted process that validated the authentication credentials.
    """

    logon_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    logon_type_id: typing.Optional[LogonTypeId] = pydantic_v1.Field(default=None)
    """
