...
class HttpActivity(UncheckedBaseModel):
    ...
    dst_endpoint: NetworkEndpoint = pydantic.Field()
    """
    ...
    http_cookies: typing.Optional[typing.List[HttpCookie]] = pydantic.Field(default=None)
    """
    The cookies object describes details about HTTP cookies
    """

    http_request: HttpRequest = pydantic.Field()
    """
    The HTTP Request Object documents attributes of a request made to a web server.
    """

    http_response: HttpResponse = pydantic.Field()
    """
