...
class SecurityFinding(UncheckedBaseModel):
    """
    ...
    analytic: typing.Optional[Analytic] = pydantic_v1.Field(default=None)
    """
    ...
    cis_csc: typing.Optional[typing.List[CisCsc]] = pydantic_v1.Field(default=None)
    """
    ...
    data_sources: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    evidence: typing.Optional[typing.Any] = pydantic_v1.Field(default=None)
    """
    The data the finding exposes to the analyst.
    """

    finding: Finding = pydantic_v1.Field()
    """
    ...
    nist: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    state_id: StateId = pydantic_v1.Field()
    """
