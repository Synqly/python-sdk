...
class DigitalSignature(UncheckedBaseModel):
    ...
    algorithm_id: DigitalSignatureAlgorithmId = pydantic_v1.Field()
    """
    ...
    developer_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The developer ID on the certificate that signed the file.
    """

    digest: typing.Optional[Fingerprint] = pydantic_v1.Field(default=None)
    """
    ...
    state_id: typing.Optional[DigitalSignatureStateId] = pydantic_v1.Field(default=None)
    """
