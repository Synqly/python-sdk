...
class FileActivity(UncheckedBaseModel):
    """
    ...
    component: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    connection_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    create_mask: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    file_diff: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
