...
class Cvss(UncheckedBaseModel):
    ...
    depth: typing.Optional[CvssDepth] = pydantic_v1.Field(default=None)
    """
    ...
    overall_score: typing.Optional[float] = pydantic_v1.Field(default=None)
    """
    ...
    vector_string: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
