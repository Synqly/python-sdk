...
class IncidentFinding(UncheckedBaseModel):
    """
    ...
    assignee: typing.Optional[User] = pydantic_v1.Field(default=None)
    """
    The details of the user assigned to an Incident.
    """

    assignee_group: typing.Optional[Group] = pydantic_v1.Field(default=None)
    """
    ...
    finding_info_list: typing.List[FindingInfo] = pydantic_v1.Field()
    """
    ...
    is_suspected_breach: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    priority: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The priority, normalized to the caption of the priority_id value. In the case of 'Other', it is defined by the event source.
    """

    priority_id: typing.Optional[PriorityId] = pydantic_v1.Field(default=None)
    """
    ...
    status_id: StatusId = pydantic_v1.Field()
    """
    The normalized status identifier of the Incident.
    """

    ticket: typing.Optional[Ticket] = pydantic_v1.Field(default=None)
    """
    ...
    verdict: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The verdict assigned to an Incident finding.
    """

    verdict_id: typing.Optional[VerdictId] = pydantic_v1.Field(default=None)
    """
