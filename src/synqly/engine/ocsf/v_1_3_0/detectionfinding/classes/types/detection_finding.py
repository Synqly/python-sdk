...
class DetectionFinding(UncheckedBaseModel):
    ...
    evidences: typing.Optional[typing.List[Evidences]] = pydantic_v1.Field(default=None)
    """
    ...
    impact: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The impact , normalized to the caption of the impact_id value. In the case of 'Other', it is defined by the event source.
    """

    impact_id: typing.Optional[ImpactId] = pydantic_v1.Field(default=None)
    """
    The normalized impact of the finding.
    """

    impact_score: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
