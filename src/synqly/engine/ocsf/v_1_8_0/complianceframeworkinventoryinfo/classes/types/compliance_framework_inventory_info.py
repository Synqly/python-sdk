...
from ....objects.types.compliance_framework import ComplianceFramework
...
class ComplianceFrameworkInventoryInfo(UncheckedBaseModel):
    """
    ...
    compliance_framework: ComplianceFramework = pydantic.Field()
    """
...
update_forward_refs(ComplianceFrameworkInventoryInfo)
