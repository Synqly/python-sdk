...
from ....objects.types.training_campaign import TrainingCampaign
...
class TrainingCampaignInventoryInfo(UncheckedBaseModel):
    """
    ...
    training_campaign: TrainingCampaign = pydantic.Field()
    """
...
update_forward_refs(TrainingCampaignInventoryInfo)
