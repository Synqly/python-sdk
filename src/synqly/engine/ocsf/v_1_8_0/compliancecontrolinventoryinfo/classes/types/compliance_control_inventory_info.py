...
from ....objects.types.compliance_control import ComplianceControl
...
class ComplianceControlInventoryInfo(UncheckedBaseModel):
    """
    ...
    compliance_control: ComplianceControl = pydantic.Field()
    """
...
update_forward_refs(ComplianceControlInventoryInfo)
