...
class SoftwareInfo(UncheckedBaseModel):
    """
    ...
    package: typing.Optional[Package] = pydantic.Field(default=None)
    """
...
update_forward_refs(SoftwareInfo)
