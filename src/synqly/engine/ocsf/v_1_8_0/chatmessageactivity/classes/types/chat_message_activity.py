...
from ....objects.types.chat_message import ChatMessage
...
class ChatMessageActivity(UncheckedBaseModel):
    """
    ...
    chat_message: ChatMessage = pydantic.Field()
    """
...
update_forward_refs(ChatMessageActivity)
