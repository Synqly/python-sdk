...
from ....objects.types.phishing_program import PhishingProgram
from ....objects.types.phishing_simulation import PhishingSimulation
...
class PhishingSimulationInventoryInfo(UncheckedBaseModel):
    """
    ...
    phishing_program: typing.Optional[PhishingProgram] = pydantic.Field(default=None)
    """
    The phishing program that the phishing simulation belongs to.
    """

    phishing_simulation: PhishingSimulation = pydantic.Field()
    """
...
update_forward_refs(PhishingSimulationInventoryInfo)
