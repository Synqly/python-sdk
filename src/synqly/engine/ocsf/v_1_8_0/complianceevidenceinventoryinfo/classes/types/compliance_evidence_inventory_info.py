...
from ....objects.types.compliance_evidence import ComplianceEvidence
...
class ComplianceEvidenceInventoryInfo(UncheckedBaseModel):
    """
    ...
    compliance_evidence: ComplianceEvidence = pydantic.Field()
    """
...
update_forward_refs(ComplianceEvidenceInventoryInfo)
