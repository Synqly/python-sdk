...
class PermissionAnalysisResult(UncheckedBaseModel):
    ...
    service_privilege_analysis_list: typing.Optional[typing.List[ServicePrivilegeAnalysis]] = pydantic.Field(
        default=None
    )
    """
    ...
    total_potential_attacks_count: typing.Optional[int] = pydantic.Field(default=None)
    """
