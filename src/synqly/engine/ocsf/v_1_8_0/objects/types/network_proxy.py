...
class NetworkProxy(UncheckedBaseModel):
    ...
    fingerprints: typing.Optional[typing.List[Fingerprint]] = pydantic.Field(default=None)
    """
    ...
    network_scope_id: typing.Optional[NetworkProxyNetworkScopeId] = pydantic.Field(default=None)
    """
...
update_forward_refs(NetworkProxy, LdapPerson=LdapPerson, User=User)
