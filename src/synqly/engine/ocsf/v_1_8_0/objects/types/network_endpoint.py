...
class NetworkEndpoint(UncheckedBaseModel):
    ...
    network_scope_id: typing.Optional[NetworkEndpointNetworkScopeId] = pydantic.Field(default=None)
    """
...
update_forward_refs(NetworkEndpoint, LdapPerson=LdapPerson, User=User)
