...
class DeviceHwInfo(UncheckedBaseModel):
    ...
    cpu_architecture: typing.Optional[str] = pydantic.Field(default=None)
    """
    ...
    cpu_architecture_id: typing.Optional[DeviceHwInfoCpuArchitectureId] = pydantic.Field(default=None)
    """
    ...
    gpu_info_list: typing.Optional[typing.List[GpuInfo]] = pydantic.Field(default=None)
    """
