...
class Tls(UncheckedBaseModel):
    ...
    ja_3_hash: typing_extensions.Annotated[
        typing.Optional[Fingerprint],
        FieldMetadata(alias="ja3_hash"),
        pydantic.Field(alias="ja3_hash", description="The MD5 hash of a JA3 string."),
    ] = None
    ja_3_s_hash: typing_extensions.Annotated[
        typing.Optional[Fingerprint],
        FieldMetadata(alias="ja3s_hash"),
        pydantic.Field(alias="ja3s_hash", description="The MD5 hash of a JA3S string."),
    ] = None
