...
class Email(UncheckedBaseModel):
    ...
    from_: typing_extensions.Annotated[
        typing.Optional[EmailAddress],
        FieldMetadata(alias="from"),
        pydantic.Field(
            alias="from",
            description="The machine-readable email header From value, as defined by RFC 5322. For example <code>example.user@usersdomain.com</code>.",
        ),
    ] = None
    ...
    is_delivered: typing.Optional[bool] = pydantic.Field(default=None)
    """
    ...
    url_count: typing.Optional[int] = pydantic.Field(default=None)
    """
