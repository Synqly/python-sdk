...
from ....objects.types.compliance_test import ComplianceTest
...
class ComplianceTestInventoryInfo(UncheckedBaseModel):
    """
    ...
    compliance_test: ComplianceTest = pydantic.Field()
    """
...
update_forward_refs(ComplianceTestInventoryInfo)
