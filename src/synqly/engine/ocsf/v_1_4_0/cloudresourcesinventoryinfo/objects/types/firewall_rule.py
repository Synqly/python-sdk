...
class FirewallRule(UncheckedBaseModel):
    ...
    condition: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    match_details: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    The data in a request that rule matched. For example: '["10","and","1"]'.
    """

    match_location: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    sensitivity: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
