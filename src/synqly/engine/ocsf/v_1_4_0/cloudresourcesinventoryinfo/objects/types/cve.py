...
class Cve(UncheckedBaseModel):
    ...
    cvss: typing.Optional[typing.List[Cvss]] = pydantic_v1.Field(default=None)
    """
    ...
    cwe: typing.Optional[Cwe] = pydantic_v1.Field(default=None)
    """
    ...
    cwe_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    cwe_url: typing.Optional[UrlString] = pydantic_v1.Field(default=None)
    """
    ...
    epss: typing.Optional[Epss] = pydantic_v1.Field(default=None)
    """
