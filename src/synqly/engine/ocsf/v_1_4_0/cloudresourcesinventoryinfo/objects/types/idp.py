...
class Idp(UncheckedBaseModel):
    ...
    fingerprint: typing.Optional[Fingerprint] = pydantic_v1.Field(default=None)
    """
    ...
    scim: typing.Optional[Scim] = pydantic_v1.Field(default=None)
    """
    ...
    sso: typing.Optional[Sso] = pydantic_v1.Field(default=None)
    """
    ...
    state_id: typing.Optional[IdpStateId] = pydantic_v1.Field(default=None)
    """
