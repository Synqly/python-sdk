...
class Location(UncheckedBaseModel):
    ...
    aerial_height: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    continent: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The name of the continent.
    """

    coordinates: typing.Optional[typing.List[float]] = pydantic_v1.Field(default=None)
    """
    ...
    geodetic_altitude: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    geodetic_vertical_accuracy: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    geohash: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    horizontal_accuracy: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    Provides quality/containment on horizontal position. This is based on ADS-B NACp. Measured in meters.
    """

    is_on_premises: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    lat: typing.Optional[float] = pydantic_v1.Field(default=None)
    """
    The geographical Latitude coordinate represented in Decimal Degrees (DD). For example: <code>42.361145</code>.
    """

    long_: typing.Optional[float] = pydantic_v1.Field(alias="long", default=None)
    """
    The geographical Longitude coordinate represented in Decimal Degrees (DD). For example: <code>-71.057083</code>.
    """

    postal_code: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The postal code of the location.
    """

    pressure_altitude: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
