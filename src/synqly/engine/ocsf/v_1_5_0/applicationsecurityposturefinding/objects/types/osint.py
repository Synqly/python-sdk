...
class Osint(UncheckedBaseModel):
    ...
    answers: typing.Optional[typing.List[DnsAnswer]] = pydantic_v1.Field(default=None)
    """
    ...
    campaign: typing.Optional[Campaign] = pydantic_v1.Field(default=None)
    """
    ...
    confidence_id: typing.Optional[OsintConfidenceId] = pydantic_v1.Field(default=None)
    """
    ...
    detection_pattern_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    detection_pattern_type_id: typing.Optional[OsintDetectionPatternTypeId] = pydantic_v1.Field(default=None)
    """
    ...
    email_auth: typing.Optional[EmailAuth] = pydantic_v1.Field(default=None)
    """
    ...
    external_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    intrusion_sets: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    related_analytics: typing.Optional[typing.List[Analytic]] = pydantic_v1.Field(default=None)
    """
    ...
    script: typing.Optional[Script] = pydantic_v1.Field(default=None)
    """
    ...
    severity_id: typing.Optional[OsintSeverityId] = pydantic_v1.Field(default=None)
    """
    The normalized severity level of the threat indicator, typically reflecting its potential impact or damage.
    """

    signatures: typing.Optional[typing.List[DigitalSignature]] = pydantic_v1.Field(default=None)
    """
    ...
    threat_actor: typing.Optional[ThreatActor] = pydantic_v1.Field(default=None)
    """
    ...
    tlp: typing.Optional[OsintTlp] = pydantic_v1.Field(default=None)
    """
    ...
    type_id: OsintTypeId = pydantic_v1.Field()
    """
    ...
    uploaded_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The timestamp indicating when the associated indicator or intelligence was added to the system or repository.
    """

    uploaded_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The timestamp indicating when the associated indicator or intelligence was added to the system or repository.
    """
    ...
    vulnerabilities: typing.Optional[typing.List[Vulnerability]] = pydantic_v1.Field(default=None)
    """
    Any vulnerabilities related to an indicator or OSINT analysis.
    """

    whois: typing.Optional[Whois] = pydantic_v1.Field(default=None)
    """
