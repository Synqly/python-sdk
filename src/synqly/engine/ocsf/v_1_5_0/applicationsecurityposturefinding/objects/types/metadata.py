...
class Metadata(UncheckedBaseModel):
    ...
    correlation_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The unique identifier used to correlate events.
    """

    debug: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    Debug information about non-fatal issues with this OCSF event. Each issue is a line in this string array.
    """

    event_code: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The <code>Event ID, Code, or Name</code> that the product uses to primarily identify the event.
    """

    extension: typing.Optional[Extension] = pydantic_v1.Field(default=None)
    """
    The schema extension used to create the event.
    """

    extensions: typing.Optional[typing.List[Extension]] = pydantic_v1.Field(default=None)
    """
    ...
    log_level: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The audit level at which an event was generated.
    """

    log_name: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The event log name. For example, syslog file name or Windows logging subsystem: Security.
    """

    log_provider: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The logging provider or logging service that logged the event. For example, Microsoft-Windows-Security-Auditing.
    """

    log_version: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    logged_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    ...
    logged_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    <p>The time when the logging system collected and logged the event.</p>This attribute is distinct from the event time in that event time typically contain the time extracted from the original event. Most of the time, these two times will be different.
    """

    loggers: typing.Optional[typing.List[Logger]] = pydantic_v1.Field(default=None)
    """
    ...
    original_time: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    processed_time: typing.Optional[Timestamp] = pydantic_v1.Field(default=None)
    """
    The event processed time, such as an ETL operation.
    """

    processed_time_dt: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The event processed time, such as an ETL operation.
    """

    product: Product = pydantic_v1.Field()
    """
    The product that reported the event.
    """

    profiles: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    sequence: typing.Optional[int] = pydantic_v1.Field(default=None)
    """
    ...
    tenant_uid: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The unique tenant identifier.
    """

    transformation_info_list: typing.Optional[typing.List[TransformationInfo]] = pydantic_v1.Field(default=None)
    """
