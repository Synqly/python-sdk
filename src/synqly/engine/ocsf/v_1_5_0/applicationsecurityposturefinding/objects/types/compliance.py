...
class Compliance(UncheckedBaseModel):
    ...
    assessments: typing.Optional[typing.List[Assessment]] = pydantic_v1.Field(default=None)
    """
    ...
    checks: typing.Optional[typing.List[Check]] = pydantic_v1.Field(default=None)
    """
    ...
    control_parameters: typing.Optional[typing.List[KeyValueObject]] = pydantic_v1.Field(default=None)
    """
    ...
    standards: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
    ...
    status_details: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
