...
class AuthFactor(UncheckedBaseModel):
    ...
    factor_type: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The type of authentication factor used in an authentication attempt.
    """

    factor_type_id: AuthFactorFactorTypeId = pydantic_v1.Field()
    """
    The normalized identifier for the authentication factor.
    """

    is_hotp: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    Whether the authentication factor is an HMAC-based One-time Password (HOTP).
    """

    is_totp: typing.Optional[bool] = pydantic_v1.Field(default=None)
    """
    ...
    security_questions: typing.Optional[typing.List[str]] = pydantic_v1.Field(default=None)
    """
