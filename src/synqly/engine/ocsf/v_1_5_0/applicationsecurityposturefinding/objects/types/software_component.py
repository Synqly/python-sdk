...
class SoftwareComponent(UncheckedBaseModel):
    ...
    author: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    related_component: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The package URL (PURL) of the component that this software component has a relationship with.
    """

    relationship: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    relationship_id: typing.Optional[SoftwareComponentRelationshipId] = pydantic_v1.Field(default=None)
    """
    ...
    type_id: typing.Optional[SoftwareComponentTypeId] = pydantic_v1.Field(default=None)
    """
