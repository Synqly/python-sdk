...
class ResourceDetails(UncheckedBaseModel):
    ...
    cloud_partition: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    criticality: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    namespace: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    resource_relationship: typing.Optional[Graph] = pydantic_v1.Field(default=None)
    """
    ...
    uid: typing.Optional[ResourceUid] = pydantic_v1.Field(default=None)
    """
    The unique identifier of the resource.
    """

    uid_alt: typing.Optional[ResourceUid] = pydantic_v1.Field(default=None)
    """
