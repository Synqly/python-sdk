...
class Check(UncheckedBaseModel):
    """
    ...
    severity_id: typing.Optional[CheckSeverityId] = pydantic_v1.Field(default=None)
    """
    ...
    status_id: typing.Optional[CheckStatusId] = pydantic_v1.Field(default=None)
    """
