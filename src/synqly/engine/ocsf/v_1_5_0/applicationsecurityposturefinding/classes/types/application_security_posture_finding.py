...
class ApplicationSecurityPostureFinding(UncheckedBaseModel):
    ...
    application: typing.Optional[Application] = pydantic_v1.Field(default=None)
    """
    ...
    compliance: typing.Optional[Compliance] = pydantic_v1.Field(default=None)
    """
    ...
    finding_info: FindingInfo = pydantic_v1.Field()
    """
    ...
    resources: typing.Optional[typing.List[ResourceDetails]] = pydantic_v1.Field(default=None)
    """
    ...
    vendor_attributes: typing.Optional[VendorAttributes] = pydantic_v1.Field(default=None)
    """
