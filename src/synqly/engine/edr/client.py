...
class EdrClient:
    ...
    def query_endpoints(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/edr/endpoints",
            method="GET",
            params={"meta": meta, "limit": limit, "cursor": cursor, "order": order, "filter": filter},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryEndpointsResponse, construct_type(type_=QueryEndpointsResponse, object_=_response.json()))  # type: ignore
    ...
    def get_endpoint(self, id: Id, *, request_options: typing.Optional[RequestOptions] = None) -> GetEndpointResponse:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/edr/endpoints/{jsonable_encoder(id)}", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetEndpointResponse, construct_type(type_=GetEndpointResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_applications(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryApplicationsResponse, construct_type(type_=QueryApplicationsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def network_quarantine(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            ...
            method="POST",
            json={"state": state, "endpoint_ids": endpoint_ids, "comment": comment},
            request_options=request_options,
            omit=OMIT,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(NetworkQuarantineResponse, construct_type(type_=NetworkQuarantineResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_threatevents(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryThreatsResponse, construct_type(type_=QueryThreatsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_alerts(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryAlertsResponse, construct_type(type_=QueryAlertsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_iocs(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryIocsResponse, construct_type(type_=QueryIocsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def create_iocs(
        self, *, indicators: typing.Sequence[Indicator], request_options: typing.Optional[RequestOptions] = None
    ) -> CreateIocsResponse:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/edr/iocs", method="POST", json={"indicators": indicators}, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateIocsResponse, construct_type(type_=CreateIocsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def delete_iocs(
        ...
        *,
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/edr/iocs", method="DELETE", params={"meta": meta, "ids": ids}, request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(DeleteIocsResponse, construct_type(type_=DeleteIocsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_posture_score(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryPostureScoreResponse, construct_type(type_=QueryPostureScoreResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def query_edr_events(
        ...
        *,
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryEdrEventsResponse, construct_type(type_=QueryEdrEventsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
