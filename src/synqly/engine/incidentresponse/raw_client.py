...
class RawIncidentresponseClient:
    ...
    ) -> HttpResponse[IncidentResponseQueryEscalationPoliciesResponse]:
        """
    ...
    def query_escalation_policy_users_on_call(
        ...
        *,
        meta: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[IncidentResponseQueryEscalationPolicyUsersOnCallResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            f"v1/incident-response/escalation-policies/{encode_path_param(escalation_policy_id)}/users-on-call",
            method="GET",
            params={
                "meta": meta,
            },
...
class AsyncRawIncidentresponseClient:
    ...
    async def query_escalation_policies(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[IncidentResponseQueryEscalationPoliciesResponse]:
        """
        Returns a list of incident response escalation policies.
    ...
    async def query_escalation_policy_users_on_call(
        ...
        *,
        meta: typing.Optional[typing.Union[str, typing.Sequence[str]]] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[IncidentResponseQueryEscalationPolicyUsersOnCallResponse]:
        """
        Returns a list of users that are currently on call for an incident response escalation policy.
