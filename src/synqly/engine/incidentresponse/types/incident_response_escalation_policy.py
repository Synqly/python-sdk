...
class IncidentResponseEscalationPolicy(UncheckedBaseModel):
    ...
    escalation_rules: typing.Optional[typing.List[IncidentResponseEscalationRule]] = pydantic.Field(default=None)
    """
    ...
    teams: typing.Optional[typing.List[IncidentResponseTeamUnion]] = pydantic.Field(default=None)
    """
