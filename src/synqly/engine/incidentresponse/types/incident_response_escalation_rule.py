...
from .incident_response_escalation_target_union import IncidentResponseEscalationTargetUnion
...
class IncidentResponseEscalationRule(UncheckedBaseModel):
    ...
    targets: typing.Optional[typing.List[IncidentResponseEscalationTargetUnion]] = pydantic.Field(default=None)
    """
