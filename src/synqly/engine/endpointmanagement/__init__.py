...
_dynamic_imports: typing.Dict[str, str] = {
    ...
    "QueryDeviceApplicationsResponse": ".types",
    "QueryDeviceComplianceResponse": ".types",
    "QueryEndpointManagementDevicesResponse": ".types",
    "RemediateDeviceResponse": ".types",
    "RemediationRequest": ".types",
}
