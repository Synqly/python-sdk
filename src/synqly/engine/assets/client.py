...
class AssetsClient:
    ...
    def query_devices(
        ...
        *,
        ...
        _response = self._client_wrapper.httpx_client.request(
            "v1/assets/devices",
            method="GET",
            params={"meta": meta, "limit": limit, "cursor": cursor, "filter": filter, "order": order},
            request_options=request_options,
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(QueryDevicesResponse, construct_type(type_=QueryDevicesResponse, object_=_response.json()))  # type: ignore
    ...
    def create_asset(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/assets/devices", method="POST", json={"device": device}, request_options=request_options, omit=OMIT
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateDeviceResponse, construct_type(type_=CreateDeviceResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
    ...
    def get_labels(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/assets/labels", method="GET", params={"filter": filter}, request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(GetLabelsResponse, construct_type(type_=GetLabelsResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
