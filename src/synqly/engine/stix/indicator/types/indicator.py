...
class Indicator(CommonProperties):
    ...
    indicator_types: typing.Optional[typing.List[IndicatorTypeOv]] = pydantic_v1.Field(default=None)
    """
    A set of categorizations for this indicator.
    """

    pattern: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    ...
    pattern_type: typing.Optional[PatternTypeOv] = pydantic_v1.Field(default=None)
    """
    The type of pattern expression used in the pattern property.
    """

    pattern_version: typing.Optional[str] = pydantic_v1.Field(default=None)
    """
    The version of the pattern expression used in the pattern property.
    """

    valid_from: dt.datetime = pydantic_v1.Field()
    """
    The time from which this Indicator is considered a valid indicator of the behaviors it is related or represents.
    """

    valid_until: typing.Optional[dt.datetime] = pydantic_v1.Field(default=None)
    """
    The time at which this Indicator is no longer considered valid.
    """

    kill_chain_phases: typing.Optional[typing.List[KillChainPhase]] = pydantic_v1.Field(default=None)
    """
