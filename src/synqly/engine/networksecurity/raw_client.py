...
class RawNetworksecurityClient:
    ...
    def query_dns_log_configurations(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryDnsLogConfigurationsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/network-security/dns/log-configurations",
            method="GET",
            params={
                "meta": meta,
                "limit": limit,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=QueryDnsLogConfigurationsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
    ...
    def query_dns_events(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> HttpResponse[QueryDnsEventsResponse]:
        """
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/network-security/dns/log-events",
            method="GET",
            params={
                "meta": meta,
                "limit": limit,
        ...
        try:
            if 200 <= _response.status_code < 300:
                _data = typing.cast(
                    ...
                    construct_type(
                        type_=QueryDnsEventsResponse,  # type: ignore
                        object_=_response.json(),
                    ),
                )
                return HttpResponse(response=_response, data=_data)
...
class AsyncRawNetworksecurityClient:
    ...
    async def query_dns_log_configurations(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryDnsLogConfigurationsResponse]:
        """
        Returns DNS log configurations discovered for the integration.
    ...
    async def query_dns_events(
        ...
        *,
        ...
        cursor: typing.Optional[str] = None,
        request_options: typing.Optional[RequestOptions] = None,
    ) -> AsyncHttpResponse[QueryDnsEventsResponse]:
        """
        Returns DNS events from DNS log configurations on the
        integration. Results are normalized to OCSF DNS Activity (class_uid 4003).
