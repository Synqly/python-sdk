...
class IntegrationWebhooksClient:
    ...
    def create_webhook(
        ...
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(CreateIntegrationWebHookResponse, construct_type(type_=CreateIntegrationWebHookResponse, object_=_response.json()))  # type: ignore
    ...
    def delete_webhook(self, *, request_options: typing.Optional[RequestOptions] = None) -> None:
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/integration-webhooks", method="DELETE", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return
    ...
    def list_webhooks(
        ...
        """
        _response = self._client_wrapper.httpx_client.request(
            "v1/integration-webhooks", method="GET", request_options=request_options
        )
        try:
            if 200 <= _response.status_code < 300:
                return typing.cast(ListIntegrationWebHooksResponse, construct_type(type_=ListIntegrationWebHooksResponse, object_=_response.json()))  # type: ignore
            if _response.status_code == 400:
                raise BadRequestError(
                    typing.cast(Problem, construct_type(type_=Problem, object_=_response.json()))  # type: ignore
                )
